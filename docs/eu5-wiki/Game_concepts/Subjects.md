...
[![](/thumb.php?f=UI_subjects.png&width=330)](/File%3AUI_subjects.png)
...
* ![Estates Satisfaction Equilibrium](/thumb.php?f=Global_estate_target_satisfaction.png&width=24 "Estates Satisfaction Equilibrium") +10% Estates Satisfaction Equilibrium
* ![Pop Assimilation Speed](/thumb.php?f=Global_pop_conversion_speed.png&width=24 "Pop Assimilation Speed") −50% Pop Assimilation Speed
* ![Pop Conversion Speed %](/thumb.php?f=Global_pop_conversion_speed.png&width=24 "Pop Conversion Speed %") −50% Pop Conversion Speed %
* ![Pop Join Rebels Threshold](/thumb.php?f=Pop_join_rebel_threshold.png&width=24 "Pop Join Rebels Threshold") −10% Pop Join Rebels Threshold
...
Overlords can begin the construction of buildings in locations owned by their subjects. The overlord will pay the [![Ducats](/thumb.php?f=Resource_gold.png&width=24)](/Economy#Gold "Ducats") gold cost, but the construction materials must be supplied from the location's market. Overlords cannot cancel the construction of subject buildings, even if they started the construction.
...
Every subject also has a [![Liberty desire.png](/thumb.php?f=Liberty.png&width=24)](/Liberty_Desire "Liberty Desire") Liberty Desire value, which ranges from **+100** or **−100** and decays monthly towards **0** but can be increased or decreased by events or subject interactions. Each point of Liberty Desire decreases Loyalty by one point.

Technologies that give loyalty:

| Technology | Modifier |
| --- | --- |
| [![Age of renaissance.png](/thumb.php?f=Age_2_renaissance.png&width=24)](/Renaissance "Renaissance") Late Feudal Relations | +5 |
| [![Age of absolutism.png](/thumb.php?f=Age_5_absolutism.png&width=24)](/Absolutism "Absolutism") Absolute Loyalty | +5 |

## Diplomatic annexation

|  |  |
| --- | --- |
| ![Ambox outdated info.png](https://central.paradoxwikis.com/images/thumb/6/65/Ambox_outdated_info.png/22px-Ambox_outdated_info.png) | Please help with verifying or updating this section. It was last verified for [version](/Europa_Universalis_5_Wiki%3AVersioning "Europa Universalis 5 Wiki:Versioning") 1.3.11. |
...
Annexing a subject also results in an [![Opinion.png](/thumb.php?f=Opinion.png&width=24)](/Opinion "Opinion") Opinion modifier of **-50** (**+2** yearly) to other subjects and **-30** (**+1** yearly) to every neighbor of the annexed subject.
...
| [![Subject.png](/thumb.php?f=Subject.png&width=24)](/File%3ASubject.png) Subject type | [![Annexation speed.png](/thumb.php?f=Annexation_speed.png&width=24)](/File%3AAnnexation_speed.png) Min years for annexation | [![Subject opinions.png](/thumb.php?f=Subject_opinions.png&width=24)](/File%3ASubject_opinions.png) Min opinion required | [![Disallow subjugation.png](/thumb.php?f=Disallow_subjugation.png&width=24)](/File%3ADisallow_subjugation.png) Stalled opinion | [![Annexation speed.png](/thumb.php?f=Annexation_speed.png&width=24)](/File%3AAnnexation_speed.png) Annexation speed | [![Regent.png](/thumb.php?f=Regent.png&width=24)](/File%3ARegent.png) Inherited on no heir |
| --- | --- | --- | --- | --- | --- |
| [![Subject type appanage.png](/thumb.php?f=Subject_type_appanage.png&width=24)](/File%3ASubject_type_appanage.png) **Appanage** | 15 | **+190** | **+175** | 1 | [![Yes.png](/thumb.php?f=Yes.png&width=24)](/File%3AYes.png) |
| [![Subject type conquistador.png](/thumb.php?f=Subject_type_conquistador.png&width=24)](/File%3ASubject_type_conquistador.png) **Conquistador** | 20 | **+150** | **+125** | 1 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| [![Subject type direct imperial free city.png](/thumb.php?f=Subject_type_direct_imperial_free_city.png&width=24)](/File%3ASubject_type_direct_imperial_free_city.png) **Direct imperial free city** | 10 | **+150** | **+125** | 2 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| [![Subject type dominion.png](/thumb.php?f=Subject_type_dominion.png&width=24)](/File%3ASubject_type_dominion.png) **Dominion** | 50 | **+150** | **+125** | 1 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| [![Subject type fiefdom.png](/thumb.php?f=Subject_type_fiefdom.png&width=24)](/File%3ASubject_type_fiefdom.png) **Fiefdom** | 10 | **+150** | **+125** | 1 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| [![Subject type pronoia.png](/thumb.php?f=Subject_type_pronoia.png&width=24)](/File%3ASubject_type_pronoia.png) **Pronoia** | 20 | **+190** | **+175** | 0.5 | [![Yes.png](/thumb.php?f=Yes.png&width=24)](/File%3AYes.png) |
| [![Subject type maha samanta.png](/thumb.php?f=Subject_type_maha_samanta.png&width=24)](/File%3ASubject_type_maha_samanta.png) **Maha samanta** | 10 | **+125** | **+100** | 2 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| [![Subject type vassal.png](/thumb.php?f=Subject_type_vassal.png&width=24)](/File%3ASubject_type_vassal.png) **Vassal** | 10 | **+150** | **+125** | 1 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| [![Subject type uc bey.png](/thumb.php?f=Subject_type_uc_bey.png&width=24)](/File%3ASubject_type_uc_bey.png) **Uç Bey** | 10 | **+190** |  | 1 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
...
| --- | --- | --- |
| **Decentralization** | 0 to **+33%** | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| **Centralization** | 0 to **-33%** | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| **Subject loyalty** | 0 to **+20%** | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| **Dominant culture** | **+100%** | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |
| **Population vs Overlord** | **+100%** to **+?%** | [![Yes.png](/thumb.php?f=Yes.png&width=24)](/File%3AYes.png) |
| **Cultural influence vs tradition** | **-50%** to **+50%** | [![Yes.png](/thumb.php?f=Yes.png&width=24)](/File%3AYes.png) |
| **Annexing multiple vassals** | **-50%** per vassal over 1 | [![No.png](/thumb.php?f=No.png&width=24)](/File%3ANo.png) |

You can find more information on each of the above modifiers and how they function below:

* [![Diplomatic spending cost.png](/thumb.php?f=Diplomatic_spending_cost.png&width=30)](/Diplomatic_spending_cost "Diplomatic spending cost") Diplomatic spending. At max this adds 0.5 on top of the 0.5 base value nations get, essentially doubling the base speed.
  + diplomatic\_maintenance\_mod is the nested modifier inside diplomatic\_maintenance\_mod that applies this.
* [![Societal value decentralization.png](/thumb.php?f=Societal_value_decentralization.png&width=30)](/Decentralization "Decentralization") Decentralization at max reduces annexation speed by **−33%**
* [![Societal value centralization.png](/thumb.php?f=Societal_value_centralization.png&width=30)](/Centralization "Centralization") Centralization at max increases annexation speed by **+33%**
  + This means the difference between 100 centralization and 100 decentralization is an effective value of 66%.
* [![Subject loyalty.png](/thumb.php?f=Subject_loyalty.png&width=30)](/Subject_loyalty "Subject loyalty") Subject loyalty. Every 1% subject loyalty is equivalent to a **+0.2%** modifier to annexation speed, maxing out at **+20%**. Diplomatic spending also increases subject loyalty.
* [![Cultural primary.png](/thumb.php?f=Cultural_primary.png&width=30)](/Cultural_primary "Cultural primary") Dominant culture. If the nation's primary culture matches your own, you get a **+100%** speed modifier to your annexation speed. You can convert a nation's culture at the cost of a decaying **-100** loyalty modifier with a cooldown of 10 years (as of v1.2)
* [![Population.png](/thumb.php?f=Population.png&width=30)](/Population "Population") Population. If an overlord's vassal's population is at least only 10% of the overlord nation's population, the overlord shall get get the "is much smaller" modifier. This scales starting at **+100%** speed for 10% of the overlord's population and scales up based on how much smaller the subject's population is compared to the overlord.
...
* [![Military stance normal.png](/thumb.php?f=Military_stance_normal.png&width=30)](/File%3AMilitary_stance_normal.png) Normal: Subject will take a balanced approach to military tactics.
* [![Military stance aggressive.png](/thumb.php?f=Military_stance_aggressive.png&width=30)](/File%3AMilitary_stance_aggressive.png) Aggressive: Subject will try to start sieges and chase units in enemy territory.
* [![Military stance supportive.png](/thumb.php?f=Military_stance_supportive.png&width=30)](/File%3AMilitary_stance_supportive.png) Supportive: Subject will try to help overlord units.
* [![Military stance passive.png](/thumb.php?f=Military_stance_passive.png&width=30)](/File%3AMilitary_stance_passive.png) Passive: Subject will try to do low-risk actions like blockading and defending friendly territory.
* [![Military stance defensive.png](/thumb.php?f=Military_stance_defensive.png&width=30)](/File%3AMilitary_stance_defensive.png) Defensive: Subject will try to stop enemies from doing anything in allied lands only.

## Subject types

|  |  |
| --- | --- |
| ![Templates Information icon.png](https://central.paradoxwikis.com/images/thumb/8/8c/Templates_Information_icon.png/30px-Templates_Information_icon.png) | **This section is planned to be [automatically generated](/Europa_Universalis_5_Wiki%3AAutogeneration "Europa Universalis 5 Wiki:Autogeneration") and should not be edited directly.**  Instead, suggest changes on the **[talk page](/index.php?title=Talk:Subjects&action=edit&redlink=1 "Talk:Subjects (page does not exist)")**. |
