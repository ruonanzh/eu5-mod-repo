<!-- source: https://eu5.paradoxwikis.com/PDX_Flag_Builder revid: 35531 fetched: 2026-09-09 -->
# PDX Flag Builder

**[Modding tool](/Category%3AModding_tools "Category:Modding tools")**: PDX Flag Builder
...
[Link](https://github.com/kaiser-chris/pdx-flag-builder)

---

**Download**

[Link](https://github.com/kaiser-chris/pdx-flag-builder/releases)
...
[![](/thumb.php?f=Pdx-flag-builder_screenshot.png&width=300)](/File%3APdx-flag-builder_screenshot.png)
...
1. Open the settings
2. Add a new path
3. Choose on of the game folders or a mod folder
4. Save your settings

[![](/thumb.php?f=Pdx-flag-builder_settings.png&width=300)](/File%3APdx-flag-builder_settings.png)
...
* waving flag by Suncheli Project from [Noun Project](https://thenounproject.com/browse/icons/term/waving-flag/) (CC BY 3.0)
* Delete by Chehuna from [Noun Project](https://thenounproject.com/browse/icons/term/delete/) (CC BY 3.0)
* edit by etika ariatna from [Noun Project](https://thenounproject.com/browse/icons/term/edit/) (CC BY 3.0)
...
|  |  |
| --- | --- |
| Tools | [Arcanum](/Arcanum "Arcanum") • [PDX DeepL](/PDX_DeepL "PDX DeepL") • PDX Flag Builder • [PDX Workshop Manager](/PDX_Workshop_Manager "PDX Workshop Manager") • [Community Mod Toolkit](/Community_Mod_Toolkit "Community Mod Toolkit") • **[Add Your Tool to the Wiki](/Form%3AModding_tool "Form:Modding tool")** |