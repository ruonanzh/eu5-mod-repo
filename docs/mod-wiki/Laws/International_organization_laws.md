...
![Default.png](/thumb.php?f=Default.png&width=18) International organization
...
[![icon](/thumb.php?f=Liturgical_practices.png&width=64)](/File%3ALiturgical_practices.png "icon")
...
Requires Vote
:   [![Requires Vote](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Requires Vote")

| Policy | Time to implement | Price |
| --- | --- | --- |
| **Byzantine Rites** By adhering to practices popularized by Byzantine priests, we can borrow some of the legitimacy of their faiths. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Local Rites** Emphasize our own local rites over others. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Catholicism-Influenced Rites** Introduce rites such as mass, sacraments and liturgy of the hours, in adjacency to the Catholicism practices. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Christological Debates

[![icon](/thumb.php?f=Christological_debates_tenet.png&width=64)](/File%3AChristological_debates_tenet.png "icon")
...
| Policy | Time to implement | Price |
| --- | --- | --- |
| **Allow Christological Debates** Our patriarchate will integrate this aspect into its core beliefs, embraced by all our members. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Forbid Christological Debates** Our patriarchate will reject this aspect into its core beliefs, embraced by all our members. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Double Sabbath

[![icon](/thumb.php?f=Double_sabbath_tenet.png&width=64)](/File%3ADouble_sabbath_tenet.png "icon")
...
| Policy | Time to implement | Price |
| --- | --- | --- |
| **Allow Double Sabbath** Both Sunday and Saturday are considered sacred. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Forbid Double Sabbath** The observance of the Sabbath is no longer necessary when celebrating the Lord's Day on Sunday. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Interpatriarchal Relations

[![icon](/thumb.php?f=Interpatriarchal_relations_tenet.png&width=64)](/File%3AInterpatriarchal_relations_tenet.png "icon")
...
| Policy | Time to implement | Price |
| --- | --- | --- |
| **Cooperation Between Patriarchs** The Patriarchs should work together for the greater benefit of the Church as a whole, even if each one of them retains the full authority of their Patriarchy. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Independent Acting Patriarchs** The Patriarchs have full authority over their own Patriarchies, and thus can decide independently the best course of action for them without the need of any discussion with the other Patriarchs. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Ruler and Patriarch Relations

[![icon](/thumb.php?f=Ruler_and_patriarch_tenet.png&width=64)](/File%3ARuler_and_patriarch_tenet.png "icon")
...
| --- | --- | --- | --- |
| **Caesaropapism** The earthly rulers are the main guardians and guarantors of the Church, and as such their decisions affect how the Patriarch operates. They are the representatives of God, to rule His kingdom here on Earth. | * leader\_country:   + Not:     - has\_policy: separated\_patriarchate\_policy | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Independent Authorities** Render unto Caesar the things that are Caesar's, and unto God the things that are God's. |  | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

### Religious Laws

#### Nature

[![icon](/thumb.php?f=Nature_tenet.png&width=64)](/File%3ANature_tenet.png "icon")
...
* custom\_tooltip:
  ...
  + At least one of:
    - All of:
      * var:religion: [![Orthodoxy](/thumb.php?f=Religion_orthodox.png&width=32)](/Religion#Orthodoxy "Orthodoxy") [Orthodoxy](/Religion#Orthodoxy "Religion")
      * international\_organization\_has\_policy: [Dual Nature](/Law#Nature "Law")
    - All of:
      * var:religion: [![Miaphysitism](/thumb.php?f=Religion_miaphysite.png&width=32)](/Religion#Miaphysitism "Miaphysitism") [Miaphysitism](/Religion#Miaphysitism "Religion")
      * international\_organization\_has\_policy: [Composite Nature](/Law#Nature "Law")
    - All of:
      * var:religion: [![Nestorianism](/thumb.php?f=Religion_nestorianism.png&width=32)](/Religion#Nestorianism "Nestorianism") [Nestorianism](/Religion#Nestorianism "Religion")
      * international\_organization\_has\_policy: [Separate Nature](/Law#Nature "Law")

Requires Vote
:   [![Not Requires Vote](/thumb.php?f=No.png&width=20)](/File%3ANo.png "Not Requires Vote")

| Policy | Requirements | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **Single Nature** There can only be one nature of Jesus. | * var:religion:   + Neither of:     - this: [![Orthodoxy](/thumb.php?f=Religion_orthodox.png&width=32)](/Religion#Orthodoxy "Orthodoxy") [Orthodoxy](/Religion#Orthodoxy "Religion")     - this: [![Miaphysitism](/thumb.php?f=Religion_miaphysite.png&width=32)](/Religion#Miaphysitism "Miaphysitism") [Miaphysitism](/Religion#Miaphysitism "Religion")     - this: [![Nestorianism](/thumb.php?f=Religion_nestorianism.png&width=32)](/Religion#Nestorianism "Nestorianism") [Nestorianism](/Religion#Nestorianism "Religion") | 1 years | * custom\_tooltip:   + text: change\_maintenance\_tt   + every\_international\_organization\_member:     - set\_variable: enable\_single\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_composite\_nature\_pm\_variable       * remove\_variable: enable\_composite\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_dual\_nature\_pm\_variable       * remove\_variable: enable\_dual\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_separate\_nature\_pm\_variable       * remove\_variable: enable\_separate\_nature\_pm\_variable | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Composite Nature** The two natures of Jesus are combined into a single one (*μια φύσις*). | * var:religion: [![Miaphysitism](/thumb.php?f=Religion_miaphysite.png&width=32)](/Religion#Miaphysitism "Miaphysitism") [Miaphysitism](/Religion#Miaphysitism "Religion") | 1 years | * custom\_tooltip:   + text: change\_maintenance\_tt   + every\_international\_organization\_member:     - set\_variable: enable\_composite\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_single\_nature\_pm\_variable       * remove\_variable: enable\_single\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_dual\_nature\_pm\_variable       * remove\_variable: enable\_dual\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_separate\_nature\_pm\_variable       * remove\_variable: enable\_separate\_nature\_pm\_variable | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Dual Nature** The aspect of Jesus contains a dual nature, both human and divine (*Δυοφυσιτισμός*). | * var:religion: [![Orthodoxy](/thumb.php?f=Religion_orthodox.png&width=32)](/Religion#Orthodoxy "Orthodoxy") [Orthodoxy](/Religion#Orthodoxy "Religion") | 1 years | * custom\_tooltip:   + text: change\_maintenance\_tt   + every\_international\_organization\_member:     - set\_variable: enable\_dual\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_single\_nature\_pm\_variable       * remove\_variable: enable\_single\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_composite\_nature\_pm\_variable       * remove\_variable: enable\_composite\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_separate\_nature\_pm\_variable       * remove\_variable: enable\_separate\_nature\_pm\_variable | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Separate Nature** While hosting two natures, divinity and humanity, these two aspects of Jesus are completely separate. | * var:religion: [![Nestorianism](/thumb.php?f=Religion_nestorianism.png&width=32)](/Religion#Nestorianism "Nestorianism") [Nestorianism](/Religion#Nestorianism "Religion") | 1 years | * custom\_tooltip:   + text: change\_maintenance\_tt   + every\_international\_organization\_member:     - set\_variable: enable\_separate\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_single\_nature\_pm\_variable       * remove\_variable: enable\_single\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_dual\_nature\_pm\_variable       * remove\_variable: enable\_dual\_nature\_pm\_variable     - if:       * limit:         + has\_variable: enable\_composite\_nature\_pm\_variable       * remove\_variable: enable\_composite\_nature\_pm\_variable | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Christology

[![icon](/thumb.php?f=Christology.png&width=64)](/File%3AChristology.png "icon")
...
| Policy | Time to implement | Price |
| --- | --- | --- |
| **High Christology** Christ is unequivocally divine. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Low Christology** Christ is a mere human. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Essence

[![icon](/thumb.php?f=Essence_tenet.png&width=64)](/File%3AEssence_tenet.png "icon")
...
| Policy | Time to implement | Price |
| --- | --- | --- |
| **Accept the Tenet of Essence** Our patriarchate will integrate this aspect into its core beliefs, embraced by all our members. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Reject the Tenet of Essence** Our patriarchate will reject this aspect into its core beliefs, embraced by all our members. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Hypostasis

[![icon](/thumb.php?f=Person_tenet.png&width=64)](/File%3APerson_tenet.png "icon")
...
| Policy | Time to implement | Price |
| --- | --- | --- |
| **Single Hypostasis** The nature of Christ and God is one but the same. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Multiple Hypostases** Christ and God are different manifestations of the divine essence. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |

#### Prosopon

[![icon](/thumb.php?f=Prosopon_tenet.png&width=64)](/File%3AProsopon_tenet.png "icon")
...
| Policy | Time to implement | Price |
| --- | --- | --- |
| **Monoprosopic Concept** Christ has only one person. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
| **Dyoprosopic Concept** Christ has two persons, divine and human. | 1 years | * [![Religious Influence](/thumb.php?f=Church_power.png&width=24)](/Religion#Mechanics "Religious Influence") **50** |
...
[![icon](/thumb.php?f=Cc_papal_authority.png&width=64)](/File%3ACc_papal_authority.png "icon")
...
| --- | --- | --- |
| **Ultramontanism** The [GetInternationalOrganization('catholic\_church').GetLeaderTitle] has strong prerogatives and powers over the Catholic Church. The [GetInternationalOrganization('catholic\_church').GetLeaderTitle] is infallibale. | 1 years | * [![Direct excommunication allowed.png](/thumb.php?f=Direct_excommunication_allowed.png&width=32)](/File%3ADirect_excommunication_allowed.png) Direct Excommunication Allowed: yes |
...
| **Invisible Church** The [GetInternationalOrganization('catholic\_church').GetLeaderTitle] is a mere representetive role in the faith, with the authority on questions of faith placed on the ruler of the individual country. | 1 years | * [![Excommunication disabled.png](/thumb.php?f=Excommunication_disabled.png&width=32)](/File%3AExcommunication_disabled.png) Excommunication Disabled: yes |

### Estate Laws

#### The Marriage of Priests

[![icon](/thumb.php?f=Cc_marriage_of_priest.png&width=64)](/File%3ACc_marriage_of_priest.png "icon")
...
[![icon](/thumb.php?f=Cc_veneration_of_saints_and_reliquaries.png&width=64)](/File%3ACc_veneration_of_saints_and_reliquaries.png "icon")
...
[![icon](/thumb.php?f=Society_of_jesus.png&width=64)](/File%3ASociety_of_jesus.png "icon")
...
[![icon](/thumb.php?f=Cc_witchcraft.png&width=64)](/File%3ACc_witchcraft.png "icon")
...
[![icon](/thumb.php?f=Cc_indulgences.png&width=64)](/File%3ACc_indulgences.png "icon")
...
[![icon](/thumb.php?f=Cc_simony.png&width=64)](/File%3ACc_simony.png "icon")
...
[![icon](/thumb.php?f=Colonial_federation_unification.png&width=64)](/File%3AColonial_federation_unification.png "icon")
...
[![icon](/thumb.php?f=Hindu_branch_spec.png&width=64)](/File%3AHindu_branch_spec.png "icon")
...
* international\_organization\_has\_law: [![Tradition](/thumb.php?f=Hindu_branch_spec.png&width=32)](/Law#Tradition "Tradition") [Tradition](/Law#Tradition "Law")

| Policy | Country Modifier |
| --- | --- |
| **Vaishnavism** Vaishnavism is the [Hindu Branch](/Hindu_Branch "Hindu Branch") centered around the worship of Viṣṇu and his ten [Avatars](/index.php?title=Avatars&action=edit&redlink=1 "Avatars (page does not exist)"). | * [![Number of allowed avatars.png](/thumb.php?f=Number_of_allowed_avatars.png&width=32)](/File%3ANumber_of_allowed_avatars.png) **+3.00** Avatars Allowed |
| **Shaivism** Shaivism is the [Hindu Branch](/Hindu_Branch "Hindu Branch") revering Śiva as the supreme [God](/index.php?title=God&action=edit&redlink=1 "God (page does not exist)"). It is the [Hindu Branch](/Hindu_Branch "Hindu Branch") more focused on asceticism and yoga. | * [![Allow self control positive.png](/thumb.php?f=Allow_self_control_positive.png&width=32)](/File%3AAllow_self_control_positive.png) Enable Self Control: **yes** |
| **Shaktism** Shaktism is the [Hindu Branch](/Hindu_Branch "Hindu Branch") centered around the worship of the Mother Goddess, known as Devī or Śakti, represented and revered in her many different forms. | * [![Number of allowed avatars.png](/thumb.php?f=Number_of_allowed_avatars.png&width=32)](/File%3ANumber_of_allowed_avatars.png) **+1.00** Avatars Allowed |
| **Smartism** Smartism is the [Hindu Branch](/Hindu_Branch "Hindu Branch") that does not consider any [God](/index.php?title=God&action=edit&redlink=1 "God (page does not exist)") to be above any other, and instead worships equally the five [Gods](/index.php?title=Gods&action=edit&redlink=1 "Gods (page does not exist)") Gaṇeśa, Śiva, Śakti, Viṣṇu, and Sūrya. | * [![Allow smartism gods positive.png](/thumb.php?f=Allow_smartism_gods_positive.png&width=32)](/File%3AAllow_smartism_gods_positive.png) Enable Smartism Gods: **yes** |
...
[![icon](/thumb.php?f=Golden_bull.png&width=64)](/File%3AGolden_bull.png "icon")
...
* custom\_description:
  ...
  + subject: [![Golden Bull](/thumb.php?f=Golden_bull.png&width=32)](/Law#Golden_Bull "Golden Bull") [Golden Bull](/Law#Golden_Bull "Law")
  + hre\_has\_locked\_law:
    - law: golden\_bull

| Policy | Country Modifier | On Activate | International Organization Modifier |
| --- | --- | --- | --- |
| **Seal the Golden Bull** The Golden Bull is the decree of the Holy Roman Empire which defines and creates the constitutional structure of the Empire, especially the Electoral College. Other laws and Imperial Reforms all build on the Golden Bull. | * [![Imperial authority modifier.png](/thumb.php?f=Imperial_authority_modifier.png&width=32)](/File%3AImperial_authority_modifier.png) **+0.02** Monthly Imperial Authority | * hre\_lock\_law:   + law: golden\_bull * hre\_setup\_hre\_variables: True * hre\_enable\_all\_imperial\_laws: True * hre\_on\_reform\_passed\_effect:   + amount: imperial\_authority\_golden\_bull * custom\_tooltip: hre\_golden\_bull\_formalizes\_electorate\_tt * custom\_tooltip: hre\_golden\_bull\_self\_voting\_regulated\_via\_electorate\_law | * [![Hre enable leave hre peace treaty.png](/thumb.php?f=Hre_enable_leave_hre_peace_treaty.png&width=32)](/File%3AHre_enable_leave_hre_peace_treaty.png) Enable Leave the Holy Roman Empire Peace: **yes** * [![Cannot declare wars.png](/thumb.php?f=Cannot_declare_wars.png&width=32)](/File%3ACannot_declare_wars.png) Forbidden Unjustified Wars Against Other Members: yes |
| **Uncodified Electoral Order** Without the Golden Bull, the Holy Roman Empire's electoral and constitutional arrangements remain a patchwork of custom, precedent, and shifting alliances. The absence of a formal decree leaves the [Electoral College](/Electoral_College "Electoral College") more susceptible to disputes, intrigue, and political maneuvering. |  |  | * [![Is hre elector.png](/thumb.php?f=Is_hre_elector.png&width=32)](/File%3AIs_hre_elector.png) Allow Self Voting: **yes** |

#### Imperial Circles

[![icon](/thumb.php?f=Imperial_circles_law.png&width=64)](/File%3AImperial_circles_law.png "icon")
...
* custom\_description:
  + text: hre\_has\_locked\_law
  + subject: [![Imperial Circles](/thumb.php?f=Imperial_circles_law.png&width=32)](/Law#Imperial_Circles "Imperial Circles") [Imperial Circles](/Law#Imperial_Circles "Law")
  + At least one of:
...
| --- | --- | --- | --- |
| **No Imperial Circles** The Holy Roman Empire has no formal geographic subdivisions. |  | * [![Imperial authority modifier.png](/thumb.php?f=Imperial_authority_modifier.png&width=32)](/File%3AImperial_authority_modifier.png) **+0.02** Monthly Imperial Authority |  |
...
[![icon](/thumb.php?f=Landfriede_law.png&width=64)](/File%3ALandfriede_law.png "icon")
...
| --- | --- | --- | --- | --- | --- |
| **Absence of Landfriede** 'Might makes right' accurately describes the current practical politics of the Holy Roman Empire; disputes between our members will be resolved on the battlefield. | * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law")   + policy: [Absence of Landfriede](/Law#Landfriede "Law") | * [![Stability cost.png](/thumb.php?f=Stability_cost.png&width=32)](/File%3AStability_cost.png) **−2.50%** Stability Investment Efficiency | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law |  |  |
| **Institute the Landfriede** The *Landfriede*, or 'land peace,' is a decree which dictates that disputes between members of the Holy Roman Empire must be settled in the Imperial Court rather than on the battlefield. This mandate helps us stay cohesive as an empire, rather than becoming weak through petty in-fighting. | * international\_organization\_has\_law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law")   + policy: [Institute the Landfriede](/Law#Landfriede "Law") |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law |  |  |
| **Expand the Landfriede** The *Landfriede* gains additional influence and recognition amongst members of the Holy Roman Empire. | * international\_organization\_has\_law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law")   + policy: [Expand the Landfriede](/Law#Landfriede "Law") |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law * custom\_tooltip:   + text: landfriede\_parliament\_issue\_rank\_2   + international\_organization\_unlock\_parliament\_issue\_effect:     - type: hre\_demand\_internal\_peace | * international\_organization\_lock\_parliament\_issue\_effect:   + type: hre\_demand\_internal\_peace |  |
| **Empower the Landfriede** The *Landfriede* is now a powerful institution. Members of the Holy Roman Empire greatly respect its authority. | * international\_organization\_has\_law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law")   + policy: [Empower the Landfriede](/Law#Landfriede "Law") |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law * custom\_tooltip:   + text: landfriede\_parliament\_issue\_rank\_3   + international\_organization\_unlock\_parliament\_issue\_effect:     - type: hre\_demand\_internal\_peace | * international\_organization\_lock\_parliament\_issue\_effect:   + type: hre\_demand\_internal\_peace |  |
| **Ewiger Landfriede** The *Landfriede* is at its apex of influence and power within the Holy Roman Empire, and private warfdare between member states has been permanently outlawed. Any disputes that arise are subject to judgment in the Imperial Court. | * international\_organization\_has\_law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law")   + policy: [Ewiger Landfriede](/Law#Landfriede "Law") |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law * custom\_tooltip:   + text: landfriede\_parliament\_issue\_rank\_4   + international\_organization\_unlock\_parliament\_issue\_effect:     - type: hre\_demand\_internal\_peace | * international\_organization\_lock\_parliament\_issue\_effect:   + type: hre\_demand\_internal\_peace | * [![Emperor agenda impact.png](/thumb.php?f=Emperor_agenda_impact.png&width=32)](/File%3AEmperor_agenda_impact.png) +1 Emperor-Comfort Policies |
| **Outlaw Internal Warfare** Restrict the capabilities of the members of the Holy Roman Empire and effectively outlaws warfare within the Empire. | * trigger\_if:   + limit:     - international\_organization:hre:       * has\_variable: hre\_emperor\_cannot\_change\_policies   + custom\_tooltip:     - text: hre\_allowed\_emperor\_reform\_proposals\_tt     - international\_organization:hre:       * Not:         + has\_variable: hre\_emperor\_cannot\_change\_policies * international\_organization\_has\_law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law") * hre\_num\_of\_emperor\_comfort\_policies\_active:   + value: 4 * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Landfriede](/thumb.php?f=Landfriede_law.png&width=32)](/Law#Landfriede "Landfriede") [Landfriede](/Law#Landfriede "Law")   + policy: [Outlaw Internal Warfare](/Law#Landfriede "Law") |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law * custom\_tooltip:   + text: landfriede\_parliament\_issue\_rank\_4   + international\_organization\_unlock\_parliament\_issue\_effect:     - type: hre\_demand\_internal\_peace | * international\_organization\_lock\_parliament\_issue\_effect:   + type: hre\_demand\_internal\_peace |  |

#### Imperial Diet

[![icon](/thumb.php?f=Imperial_diet_law.png&width=64)](/File%3AImperial_diet_law.png "icon")
...
* custom\_description:
  + text: hre\_has\_locked\_law
  + subject: [![Perpetual Diet](/thumb.php?f=Perpetual_diet_law.png&width=32)](/Law#Perpetual_Diet "Perpetual Diet") [Perpetual Diet](/Law#Perpetual_Diet "Law")
  + hre\_has\_locked\_law:
...
[![icon](/thumb.php?f=Power_of_the_emperor_law.png&width=64)](/File%3APower_of_the_emperor_law.png "icon")
...
* custom\_description:
  + text: hre\_has\_locked\_law
  + subject: [![Imperial Succession](/thumb.php?f=Imperial_succession_law.png&width=32)](/Law#Imperial_Succession "Imperial Succession") [Imperial Succession](/Law#Imperial_Succession "Law")
  + hre\_has\_locked\_law:
...
| --- | --- | --- | --- | --- | --- | --- |
| **Rotating Emperorship** To prevent any single ruler from consolidating power, the Empire enforces a rotation system that actively discourages re-election of incumbents. | * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law")   + policy: [Rotating Emperorship](/Law#Imperial_Voting "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_prince\_friendly\_law | * [![Is hre elector.png](/thumb.php?f=Is_hre_elector.png&width=32)](/File%3AIs_hre_elector.png) **−200.00** Reasons to Elect * [![Imperial authority modifier.png](/thumb.php?f=Imperial_authority_modifier.png&width=32)](/File%3AImperial_authority_modifier.png) **−0.025** Monthly Imperial Authority | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_prince\_friendly\_law |  | * [![Emperor agenda impact.png](/thumb.php?f=Emperor_agenda_impact.png&width=32)](/File%3AEmperor_agenda_impact.png) −1 Emperor-Comfort Policies |  |
| **Free Electorate** Electors are fully independent in choosing the next Emperor. Self-voting is permitted. | * international\_organization\_has\_law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law")   + policy: [Free Electorate](/Law#Imperial_Voting "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_prince\_friendly\_law |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_prince\_friendly\_law |  | * [![Is hre elector.png](/thumb.php?f=Is_hre_elector.png&width=32)](/File%3AIs_hre_elector.png) Allow Self Voting: **yes** |  |
| **Emperor Dynastic Preference** Electors favor candidates belonging to the Emperor's dynasty, consolidating dynastic power over the electoral system. | * international\_organization\_has\_law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law")   + policy: [Emperor Dynastic Preference](/Law#Imperial_Voting "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_uncontroversial\_law |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_uncontroversial\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: controversial |  | * [![Is hre elector.png](/thumb.php?f=Is_hre_elector.png&width=32)](/File%3AIs_hre_elector.png) Allow Self Voting: **yes** |  |
| **Emperor Successor Preference** The Emperor promotes the candidacy of their own successor. Imperial policy begins to favor dynastic continuity. | * international\_organization\_has\_law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law")   + policy: [Emperor Successor Preference](/Law#Imperial_Voting "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_opposed\_law | * [![Is hre elector.png](/thumb.php?f=Is_hre_elector.png&width=32)](/File%3AIs_hre_elector.png) **+50.00** Reasons to Elect * [![Imperial authority modifier.png](/thumb.php?f=Imperial_authority_modifier.png&width=32)](/File%3AImperial_authority_modifier.png) **+0.02** Monthly Imperial Authority | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_opposed\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: opposed |  |  |  |
| **Erbkaisertum** The elective monarchy is abolished. The Empire becomes a fully hereditary monarchy, solidifying dynastic rule at the cost of Imperial legitimacy. | * international\_organization\_has\_law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Voting](/thumb.php?f=Imperial_voting_law.png&width=32)](/Law#Imperial_Voting "Imperial Voting") [Imperial Voting](/Law#Imperial_Voting "Law")   + policy: [Erbkaisertum](/Law#Imperial_Voting "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_opposed\_law | * [![Imperial authority modifier.png](/thumb.php?f=Imperial_authority_modifier.png&width=32)](/File%3AImperial_authority_modifier.png) **−0.05** Monthly Imperial Authority | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_opposed\_law * hre\_lock\_law:   + law: electorate\_organization\_law * hre\_lock\_law:   + law: electorate\_religion\_law * hre\_lock\_law:   + law: imperial\_succession\_law * hre\_enact\_fixed\_succession: True * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: opposed | * hre\_unlock\_law:   + law: electorate\_organization\_law * hre\_unlock\_law:   + law: electorate\_religion\_law * hre\_unlock\_law:   + law: imperial\_succession\_law * hre\_repeal\_fixed\_succession:   + policy: emperor\_successor\_preference\_policy | * [![Is hre elector.png](/thumb.php?f=Is_hre_elector.png&width=32)](/File%3AIs_hre_elector.png) Allow Self Voting: **yes** * [![Emperor agenda impact.png](/thumb.php?f=Emperor_agenda_impact.png&width=32)](/File%3AEmperor_agenda_impact.png) +1 Emperor-Comfort Policies | none |

#### Electorate Organization

[![icon](/thumb.php?f=Electorate_organization_law.png&width=64)](/File%3AElectorate_organization_law.png "icon")
...
| Policy | Requirements | Country Modifier | On Activate |
| --- | --- | --- | --- |
| **Traditional Electorate** The Electorate of the Holy Roman Empire remains split between Prince-Elector and Archbishop-Elector. | * international\_organization\_has\_law: [![Electorate Organization](/thumb.php?f=Electorate_organization_law.png&width=32)](/Law#Electorate_Organization "Electorate Organization") [Electorate Organization](/Law#Electorate_Organization "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Electorate Organization](/thumb.php?f=Electorate_organization_law.png&width=32)](/Law#Electorate_Organization "Electorate Organization") [Electorate Organization](/Law#Electorate_Organization "Law")   + policy: [Elector Council](/Law#Electorate_Organization "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_prince\_friendly\_law | * [![Imperial authority modifier.png](/thumb.php?f=Imperial_authority_modifier.png&width=32)](/File%3AImperial_authority_modifier.png) **+0.005** Monthly Imperial Authority | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_prince\_friendly\_law |
...
[![icon](/thumb.php?f=Free_city_law.png&width=64)](/File%3AFree_city_law.png "icon")
...
[![icon](/thumb.php?f=Military_contribution.png&width=64)](/File%3AMilitary_contribution.png "icon")
...
| --- | --- | --- | --- | --- | --- |
| **No Military Contribution** None of the estates are obligated to provide the [GetUniqueInternationalOrganization('hre').GetLeaderTitle] with additional troops. | * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_prince\_friendly\_law * international\_organization\_has\_law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law")   + policy: [No Military Contribution](/Law#Imperial_Register "Law") |  | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_prince\_friendly\_law |  |  |
| **Imperial Armory Implementation** The [GetUniqueInternationalOrganization('hre').GetLeaderTitle] gains the privilege to construct Imperial Armory (Abroad) within the lands of the Empire. | * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_standard\_law * international\_organization\_has\_law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law")   + policy: [Imperial Armory Implementation](/Law#Imperial_Register "Law") * custom\_tooltip:   + text: has\_enabled\_hre\_treasury\_tt   + has\_enabled\_currency: gold | * [![Global manpower modifier.png](/thumb.php?f=Global_manpower_modifier.png&width=32)](/File%3AGlobal_manpower_modifier.png) **+5** Max Manpower | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: controversial | [![Manpower](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Manpower") |  |
| **Expansion of the Armories** Every Imperial Armory (Abroad) shall gain extra resources in order to expand the amount of possible soldiers recruited for the Empire. | * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_standard\_law * international\_organization\_has\_law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law")   + policy: [Expansion of the Armories](/Law#Imperial_Register "Law") * custom\_tooltip:   + text: has\_enabled\_hre\_treasury\_tt   + has\_enabled\_currency: gold | * [![Global manpower modifier.png](/thumb.php?f=Global_manpower_modifier.png&width=32)](/File%3AGlobal_manpower_modifier.png) **+7.5** Max Manpower | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: controversial | [![Manpower](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Manpower") | * [![Global manpower modifier.png](/thumb.php?f=Global_manpower_modifier.png&width=32)](/File%3AGlobal_manpower_modifier.png) **+1** Imperial Army Building Available Level |
| **Imperial Standing Army** With further expansion of available resources for the Imperial Armory (Abroad), the [Manpower](/Manpower "Manpower") from the Empire shall allow the [GetUniqueInternationalOrganization('hre').GetLeaderTitle] to create a proper, standing army. | * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_controversial\_law * international\_organization\_has\_law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law")   + policy: [Imperial Standing Army](/Law#Imperial_Register "Law") * custom\_tooltip:   + text: has\_enabled\_hre\_treasury\_tt   + has\_enabled\_currency: gold | * [![Global manpower modifier.png](/thumb.php?f=Global_manpower_modifier.png&width=32)](/File%3AGlobal_manpower_modifier.png) **+10** Max Manpower | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_controversial\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: controversial | [![Manpower](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Manpower") | * [![Global manpower modifier.png](/thumb.php?f=Global_manpower_modifier.png&width=32)](/File%3AGlobal_manpower_modifier.png) **+2** Imperial Army Building Available Level |
| **Great Imperial Army** The final legislative level for Imperial Armory (Abroad). Once enacted, the potential of the army under the direct control of the [GetUniqueInternationalOrganization('hre').GetLeaderTitle] will reach a never-before-seen height. | * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_opposed\_law * international\_organization\_has\_law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Register](/thumb.php?f=Military_contribution.png&width=32)](/Law#Imperial_Register "Imperial Register") [Imperial Register](/Law#Imperial_Register "Law")   + policy: [Great Imperial Army](/Law#Imperial_Register "Law") * custom\_tooltip:   + text: has\_enabled\_hre\_treasury\_tt   + has\_enabled\_currency: gold | * [![Global manpower modifier.png](/thumb.php?f=Global_manpower_modifier.png&width=32)](/File%3AGlobal_manpower_modifier.png) **+0.2** Max Manpower | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_opposed\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: opposed | [![Manpower](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Manpower") | * [![Emperor agenda impact.png](/thumb.php?f=Emperor_agenda_impact.png&width=32)](/File%3AEmperor_agenda_impact.png) +1 Emperor-Comfort Policies * [![Global manpower modifier.png](/thumb.php?f=Global_manpower_modifier.png&width=32)](/File%3AGlobal_manpower_modifier.png) **+3** Imperial Army Building Available Level |

### Religious Laws

#### Imperial Religion

[![icon](/thumb.php?f=Imperial_religion.png&width=64)](/File%3AImperial_religion.png "icon")
...
[![icon](/thumb.php?f=Electorate_religion_law.png&width=64)](/File%3AElectorate_religion_law.png "icon")
...
[![icon](/thumb.php?f=Monetary_contribution.png&width=64)](/File%3AMonetary_contribution.png "icon")
...
| --- | --- | --- | --- | --- | --- | --- |
| **No Taxation** The empire is in no need of additional gold. Lifting the taxation burdens of its members allows the administration to focus on other tasks instead. | * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Tax Law](/thumb.php?f=Monetary_contribution.png&width=32)](/Law#Imperial_Tax_Law "Imperial Tax Law") [Imperial Tax Law](/Law#Imperial_Tax_Law "Law")   + policy: [No Taxation](/Law#Imperial_Tax_Law "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_standard\_law | * [![Country cabinet efficiency.png](/thumb.php?f=Country_cabinet_efficiency.png&width=32)](/File%3ACountry_cabinet_efficiency.png) **+5.00%** Efficiency of Our Cabinet | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law | [![Not Gold](/thumb.php?f=No.png&width=20)](/File%3ANo.png "Not Gold") |  |  |
| **Treasury Taxation** While the [GetUniqueInternationalOrganization('hre').GetLeaderTitle] can open their own coffers to solve many issues, a financial buffer in the form of a proper treasury would allow the current and future emperors to better finance internal affairs in the Holy Roman Empire. | * international\_organization\_has\_law: [![Imperial Tax Law](/thumb.php?f=Monetary_contribution.png&width=32)](/Law#Imperial_Tax_Law "Imperial Tax Law") [Imperial Tax Law](/Law#Imperial_Tax_Law "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Tax Law](/thumb.php?f=Monetary_contribution.png&width=32)](/Law#Imperial_Tax_Law "Imperial Tax Law") [Imperial Tax Law](/Law#Imperial_Tax_Law "Law")   + policy: [Treasury Taxation](/Law#Imperial_Tax_Law "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_standard\_law | * [![Monthly prestige.png](/thumb.php?f=Monthly_prestige.png&width=32)](/File%3AMonthly_prestige.png) **+0.05** Monthly Prestige | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_standard\_law | [![Gold](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Gold") | * [![Unlock contribute to organization treasury.png](/thumb.php?f=Unlock_contribute_to_organization_treasury.png&width=32)](/File%3AUnlock_contribute_to_organization_treasury.png) Unlock Contribute to Organization Treasury: **yes** | * imperial\_treasury\_contribution |
| **Direct Taxation** The Roman Month is not enough to cover the protection of the Holy Roman Empire. A new tax needs to be established which directly finances the [GetUniqueInternationalOrganization('hre').GetLeaderTitle]. | * international\_organization\_has\_law: [![Imperial Tax Law](/thumb.php?f=Monetary_contribution.png&width=32)](/Law#Imperial_Tax_Law "Imperial Tax Law") [Imperial Tax Law](/Law#Imperial_Tax_Law "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Tax Law](/thumb.php?f=Monetary_contribution.png&width=32)](/Law#Imperial_Tax_Law "Imperial Tax Law") [Imperial Tax Law](/Law#Imperial_Tax_Law "Law")   + policy: [Direct Taxation](/Law#Imperial_Tax_Law "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_controversial\_law | * [![Monthly prestige.png](/thumb.php?f=Monthly_prestige.png&width=32)](/File%3AMonthly_prestige.png) **+0.05** Monthly Prestige | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_controversial\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: controversial | [![Not Gold](/thumb.php?f=No.png&width=20)](/File%3ANo.png "Not Gold") |  | * imperial\_contribution |
| **Imperial Taxation** Only the taxation of all our member states can sustain the financial challenges of the Holy Roman Empire. | * international\_organization\_has\_law: [![Imperial Tax Law](/thumb.php?f=Monetary_contribution.png&width=32)](/Law#Imperial_Tax_Law "Imperial Tax Law") [Imperial Tax Law](/Law#Imperial_Tax_Law "Law") * hre\_can\_select\_adjacent\_reform\_level:   + law: [![Imperial Tax Law](/thumb.php?f=Monetary_contribution.png&width=32)](/Law#Imperial_Tax_Law "Imperial Tax Law") [Imperial Tax Law](/Law#Imperial_Tax_Law "Law")   + policy: [Imperial Taxation](/Law#Imperial_Tax_Law "Law") * has\_currency\_to\_vote\_for\_law:   + value: imperial\_authority\_opposed\_law | * [![Monthly prestige.png](/thumb.php?f=Monthly_prestige.png&width=32)](/File%3AMonthly_prestige.png) **+0.10** Monthly Prestige | * hre\_on\_reform\_level\_passed\_effect:   + law\_imperial\_authority\_cost: imperial\_authority\_opposed\_law * hre\_on\_reform\_level\_passed\_opinion\_effect\_all\_members:   + strength: opposed | [![Gold](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Gold") | * [![Emperor agenda impact.png](/thumb.php?f=Emperor_agenda_impact.png&width=32)](/File%3AEmperor_agenda_impact.png) +1 Emperor-Comfort Policies * [![Unlock contribute to organization treasury.png](/thumb.php?f=Unlock_contribute_to_organization_treasury.png&width=32)](/File%3AUnlock_contribute_to_organization_treasury.png) Unlock Contribute to Organization Treasury: **yes** | * imperial\_contribution * imperial\_treasury\_contribution |
...
[![icon](/thumb.php?f=Clan_residence.png&width=64)](/File%3AClan_residence.png "icon")
...
[![icon](/thumb.php?f=Jap_buke_shohatto.png&width=64)](/File%3AJap_buke_shohatto.png "icon")
...
| --- | --- | --- |
| **Enforced Buke Shohatto** Our samurai have a clear model to follow for self-improvement, and they are obligated to abide by it. | * [![Monthly towards quality.png](/thumb.php?f=Monthly_towards_quality.png&width=32)](/File%3AMonthly_towards_quality.png) +0.10 Monthly Progress to Quality * [![Monthly towards aristocracy.png](/thumb.php?f=Monthly_towards_aristocracy.png&width=32)](/File%3AMonthly_towards_aristocracy.png) +0.10 Monthly Progress to Aristocracy * [![Monthly army tradition.png](/thumb.php?f=Monthly_army_tradition.png&width=32)](/File%3AMonthly_army_tradition.png) **+0.10** Monthly Army Tradition * [![Nobles estate target satisfaction.png](/thumb.php?f=Nobles_estate_target_satisfaction.png&width=32)](/File%3ANobles_estate_target_satisfaction.png) **−5.00%** Noble Estate Satisfaction Equilibrium | * international\_organization:japanese\_shogunate.leader\_country:   + add\_stability: stability\_extreme\_penalty |
| **Buke Shohatto Guidelines** The Buke Shohatto is considered a set of general guidelines rather than hard rules, and serves as a romantic ideal to emulate rather than a strict code to obey. | * [![Monthly towards humanist.png](/thumb.php?f=Monthly_towards_humanist.png&width=32)](/File%3AMonthly_towards_humanist.png) +0.10 Monthly Progress to Humanist * [![Monthly towards decentralization.png](/thumb.php?f=Monthly_towards_decentralization.png&width=32)](/File%3AMonthly_towards_decentralization.png) +0.10 Monthly Progress to Decentralization * [![Cultural tradition.png](/thumb.php?f=Cultural_tradition.png&width=32)](/File%3ACultural_tradition.png) **+10.00%** Cultural Tradition % * [![Peasants estate target satisfaction.png](/thumb.php?f=Peasants_estate_target_satisfaction.png&width=32)](/File%3APeasants_estate_target_satisfaction.png) **−5.00%** Peasant Estate Satisfaction Equilibrium | * international\_organization:japanese\_shogunate.leader\_country:   + add\_stability: stability\_extreme\_penalty |

### Socioeconomic Laws

#### Overseas Interaction

[![icon](/thumb.php?f=Jap_sakoku_law.png&width=64)](/File%3AJap_sakoku_law.png "icon")
...
| Policy | Country Modifier | On Pay Price |
| --- | --- | --- |
| **Sakoku** Free from outside influences, our territory is sure to improve its productivity and economic growth. | * [![Trade isolation.png](/thumb.php?f=Trade_isolation.png&width=32)](/File%3ATrade_isolation.png) Foreigners Banned from Imports and Exports: **yes** * [![Stability cost.png](/thumb.php?f=Stability_cost.png&width=32)](/File%3AStability_cost.png) **+40.00%** Stability Investment Efficiency * [![Monthly towards inward.png](/thumb.php?f=Monthly_towards_inward.png&width=32)](/File%3AMonthly_towards_inward.png) +0.20 Monthly Progress to Inward | * international\_organization:japanese\_shogunate.leader\_country:   + add\_stability: stability\_extreme\_penalty |
| **Opened the Country** With our borders open to the world, both trade and new ideas can flow freely through through. | * [![Stability cost.png](/thumb.php?f=Stability_cost.png&width=32)](/File%3AStability_cost.png) **−50.00%** Stability Investment Efficiency * [![Research speed.png](/thumb.php?f=Research_speed.png&width=32)](/File%3AResearch_speed.png) **+5.00%** Monthly Research Progress % | * international\_organization:japanese\_shogunate.leader\_country:   + add\_stability: stability\_extreme\_penalty |
...
[![icon](/thumb.php?f=Local_administration.png&width=64)](/File%3ALocal_administration.png "icon")
...
| --- | --- | --- | --- | --- |
| **Tribal Administration** Administration will be handled at a tribal level, with each tribal leader making the decisions for their group. | * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized * [![Monthly towards decentralization.png](/thumb.php?f=Monthly_towards_decentralization.png&width=32)](/File%3AMonthly_towards_decentralization.png) +0.10 Monthly Progress to Decentralization * [![Monthly tribal cohesion.png](/thumb.php?f=Monthly_tribal_cohesion.png&width=32)](/File%3AMonthly_tribal_cohesion.png) **+0.05** Monthly Tribal Cohesion * [![Global estate target satisfaction.png](/thumb.php?f=Global_estate_target_satisfaction.png&width=32)](/File%3AGlobal_estate_target_satisfaction.png) **+2.50%** Estates Satisfaction Equilibrium | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty * custom\_tooltip:   + text: tribal\_administration\_policy\_tt   + every\_international\_organization\_member:     - change\_societal\_value:       * type: centralization\_vs\_decentralization       * value: societal\_value\_minor\_move\_to\_right | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Sinicized Administration** Administration will be handled at a confederation level, with the leader directing our people. | * [![Monthly towards centralization.png](/thumb.php?f=Monthly_towards_centralization.png&width=32)](/File%3AMonthly_towards_centralization.png) +0.10 Monthly Progress to Centralization * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty * custom\_tooltip:   + text: sinicized\_administration\_policy\_tt   + every\_international\_organization\_member:     - change\_societal\_value:       * type: centralization\_vs\_decentralization       * value: societal\_value\_minor\_move\_to\_left | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |

#### Bureaucratic Law

[![icon](/thumb.php?f=Civil_registration.png&width=64)](/File%3ACivil_registration.png "icon")
...
| Policy | Country Modifier | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **No Legal Framework** No legal framework will be set. | * [![Monthly tribal cohesion.png](/thumb.php?f=Monthly_tribal_cohesion.png&width=32)](/File%3AMonthly_tribal_cohesion.png) **−0.10** Monthly Tribal Cohesion * [![Diplomatic spending cost.png](/thumb.php?f=Diplomatic_spending_cost.png&width=32)](/File%3ADiplomatic_spending_cost.png) **−10.00%** Expected Diplomatic Spending * [![Monthly towards serfdom.png](/thumb.php?f=Monthly_towards_serfdom.png&width=32)](/File%3AMonthly_towards_serfdom.png) +0.10 Monthly Progress to Serfdom * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Basic Legal Framework** A basic framework will be set. | * [![Monthly towards centralization.png](/thumb.php?f=Monthly_towards_centralization.png&width=32)](/File%3AMonthly_towards_centralization.png) +0.05 Monthly Progress to Centralization * [![Global distance from capital cost modifier.png](/thumb.php?f=Global_distance_from_capital_cost_modifier.png&width=32)](/File%3AGlobal_distance_from_capital_cost_modifier.png) **+5.00%** Proximity Efficiency | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Sinicized Legal Framework** A Chinese bureaucratic system will be set. | * [![Monthly towards centralization.png](/thumb.php?f=Monthly_towards_centralization.png&width=32)](/File%3AMonthly_towards_centralization.png) +0.10 Monthly Progress to Centralization * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized * [![Monthly towards free subjects.png](/thumb.php?f=Monthly_towards_free_subjects.png&width=32)](/File%3AMonthly_towards_free_subjects.png) +0.10 Monthly Progress to Free Subjects * [![Global distance from capital cost modifier.png](/thumb.php?f=Global_distance_from_capital_cost_modifier.png&width=32)](/File%3AGlobal_distance_from_capital_cost_modifier.png) **+10.00%** Proximity Efficiency | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |

#### Unification Law

[![icon](/thumb.php?f=Unification_law.png&width=64)](/File%3AUnification_law.png "icon")
...
| --- | --- | --- | --- | --- |
| **Bid for Unification** The time to unite our decentralized tribes under a central authority has come! By adopting a more sophisticated social framework, we can make a bid to unite all tribes under our Confederation. | * leader\_country:   + [![Centralization](/thumb.php?f=Societal_value_centralization.png&width=32)](/Societal_Value#Centralization "Centralization") [Centralization](/Societal_Value#Centralization "Societal Value") > 75   + [![Sinicized](/thumb.php?f=Societal_value_sinicized.png&width=32)](/Societal_Value#Sinicized "Sinicized") [Sinicized](/Societal_Value#Sinicized "Societal Value") > 75 | 5 years | * leader\_country:   + trigger\_event\_non\_silently: jurchen\_confederation\_events.17 * custom\_tooltip: will\_ask\_members\_to\_submit\_tt | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
...
[![icon](/thumb.php?f=Six_ministries.png&width=64)](/File%3ASix_ministries.png "icon")
...
| Policy | Country Modifier | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **No Court Etiquette** No specific rules will be enforced at court. | * [![Court spending cost.png](/thumb.php?f=Get_claim_from_imperial_court_cost_modifier.png&width=32)](/File%3AGet_claim_from_imperial_court_cost_modifier.png) **+20.00%** Court Spending Efficiency * [![Monthly tribal cohesion.png](/thumb.php?f=Monthly_tribal_cohesion.png&width=32)](/File%3AMonthly_tribal_cohesion.png) **+0.05** Monthly Tribal Cohesion * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Basic Court Etiquette** Basic rules will be enforced at court. | * [![Diplomatic reputation.png](/thumb.php?f=Diplomatic_reputation.png&width=32)](/File%3ADiplomatic_reputation.png) **+1.00** Diplomatic Reputation * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.05 Monthly Progress to Sinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Sinicized Court Etiquette** Rules inspired by the Chinese court will be enforced at ours. | * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized * [![Amount looted modifier.png](/thumb.php?f=Amount_looted_modifier.png&width=32)](/File%3AAmount_looted_modifier.png) **+10.00%** Middle Kingdom Tribute Received Modifier | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |

### Socioeconomic Laws

#### Clan Taxation Law

[![icon](/thumb.php?f=Tax_obligations.png&width=64)](/File%3ATax_obligations.png "icon")
...
| Policy | Country Modifier | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **No Tax Obligations** Our people will not be subject to taxation. | * [![Stability decay.png](/thumb.php?f=Stability_decay.png&width=32)](/File%3AStability_decay.png) **−0.025%** Stability Decay * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Fair Tax Obligations** Our people will pay basic taxes. | * [![Stability decay.png](/thumb.php?f=Stability_decay.png&width=32)](/File%3AStability_decay.png) **−0.01%** Stability Decay * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.05 Monthly Progress to Sinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Extensive Tax Obligations** Our people will pay normal taxes, plus additional taxes related to luxury articles. | * [![Tax income efficiency.png](/thumb.php?f=Tax_income_efficiency.png&width=32)](/File%3ATax_income_efficiency.png) **+3.00%** Tax Efficiency * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |

#### Formal Script Law

[![icon](/thumb.php?f=Formal_script.png&width=64)](/File%3AFormal_script.png "icon")
...
| Policy | Country Modifier | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **Mongolian Script** Mongolian script will be used. | * [![Monthly towards traditionalist.png](/thumb.php?f=Monthly_towards_traditionalist.png&width=32)](/File%3AMonthly_towards_traditionalist.png) +0.10 Monthly Progress to Traditionalist * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized * [![Pop join rebel threshold.png](/thumb.php?f=Pop_join_rebel_threshold.png&width=32)](/File%3APop_join_rebel_threshold.png) **−5.00%** Pop Join Rebels Threshold | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty * custom\_tooltip:   + text: mongol\_script\_policy\_tt   + every\_international\_organization\_member:     - change\_societal\_value:       * type: traditionalist\_vs\_innovative       * value: societal\_value\_large\_move\_to\_left | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Sinicized Writing** The Chinese system of writing will be used. | * [![Research speed.png](/thumb.php?f=Research_speed.png&width=32)](/File%3AResearch_speed.png) **+5.00%** Monthly Research Progress % * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized * [![Monthly towards centralization.png](/thumb.php?f=Monthly_towards_centralization.png&width=32)](/File%3AMonthly_towards_centralization.png) +0.05 Monthly Progress to Centralization | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty * custom\_tooltip:   + text: sinicized\_script\_policy\_tt   + every\_international\_organization\_member:     - change\_societal\_value:       * type: centralization\_vs\_decentralization       * value: societal\_value\_move\_to\_left | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |

#### Economic Law

[![icon](/thumb.php?f=Economic_framework.png&width=64)](/File%3AEconomic_framework.png "icon")
...
| Policy | Country Modifier | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **Shared Crops** Settlements are encouraged to trade crops between them. | * [![Monthly towards traditional economy.png](/thumb.php?f=Monthly_towards_traditional_economy.png&width=32)](/File%3AMonthly_towards_traditional_economy.png) +0.10 Monthly Progress to Traditional Economy * [![Global max rgo size modifier.png](/thumb.php?f=Global_max_rgo_size_modifier.png&width=32)](/File%3AGlobal_max_rgo_size_modifier.png) **+20.00%** Maximum RGO Size in Rural * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Decentralized Farming Villages** Settlements are meant to be self-sustaining. | * [![Monthly towards traditional economy.png](/thumb.php?f=Monthly_towards_traditional_economy.png&width=32)](/File%3AMonthly_towards_traditional_economy.png) +0.10 Monthly Progress to Traditional Economy * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.05 Monthly Progress to Sinicized * [![Global max control.png](/thumb.php?f=Global_max_control.png&width=32)](/File%3AGlobal_max_control.png) **+10.00%** Max Rural Control | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Resource Extraction Bureaus** Distribution of crops between settlements will be carried out at the highest level. | * [![Global monthly prosperity.png](/thumb.php?f=Global_monthly_prosperity.png&width=32)](/File%3AGlobal_monthly_prosperity.png) **+0.20%** Monthly Prosperity in Urban Locations * [![Monthly towards capital economy.png](/thumb.php?f=Monthly_towards_capital_economy.png&width=32)](/File%3AMonthly_towards_capital_economy.png) +0.10 Monthly Progress to Capital Economy * [![Monthly towards centralization.png](/thumb.php?f=Monthly_towards_centralization.png&width=32)](/File%3AMonthly_towards_centralization.png) +0.05 Monthly Progress to Centralization * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |

#### Trade Relations Law

[![icon](/thumb.php?f=Trade_relations.png&width=64)](/File%3ATrade_relations.png "icon")
...
| Policy | Country Modifier | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **Restricted Clan Trade** Trade will be restricted to exchanges between clans. | * [![Market protection.png](/thumb.php?f=Market_protection.png&width=32)](/File%3AMarket_protection.png) **+10.00%** Market Protection * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized * [![Monthly tribal cohesion.png](/thumb.php?f=Monthly_tribal_cohesion.png&width=32)](/File%3AMonthly_tribal_cohesion.png) **+0.05** Monthly Tribal Cohesion | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Allow Foreign Exchanges** Trade will be free for our people. | * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.05 Monthly Progress to Sinicized * [![Burghers estate max tax.png](/thumb.php?f=Burghers_estate_max_tax.png&width=32)](/File%3ABurghers_estate_max_tax.png) **+10.00%** Maximum Tax for Burgher Estate | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Chinese Tribute** Trade with China will be allowed. | * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized * [![Trade efficiency.png](/thumb.php?f=Trade_efficiency.png&width=32)](/File%3ATrade_efficiency.png) **+1.00%** Selling Efficiency * [![Market building levels.png](/thumb.php?f=Market_building_levels.png&width=32)](/File%3AMarket_building_levels.png) **+500.00%** Trade Building Levels | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |

#### Clan Diplomacy Law

[![icon](/thumb.php?f=Clan_diplomacy.png&width=64)](/File%3AClan_diplomacy.png "icon")
...
| Policy | Country Modifier | Time to implement | On Activate | Price |
| --- | --- | --- | --- | --- |
| **No Embassies** No embassies can be set anywhere. | * [![Monthly towards unsinicized.png](/thumb.php?f=Monthly_towards_unsinicized.png&width=32)](/File%3AMonthly_towards_unsinicized.png) +0.10 Monthly Progress to Unsinicized * [![Monthly towards belligerent.png](/thumb.php?f=Monthly_towards_belligerent.png&width=32)](/File%3AMonthly_towards_belligerent.png) +0.10 Monthly Progress to Belligerent * [![Global levy size modifier.png](/thumb.php?f=Global_levy_size_modifier.png&width=32)](/File%3AGlobal_levy_size_modifier.png) **+10.00%** Army Levy Size | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Clan Embassies** Clans will be allowed to carry out their own diplomatic actions. | * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.05 Monthly Progress to Sinicized * [![Diplomatic capacity.png](/thumb.php?f=Diplomatic_capacity.png&width=32)](/File%3ADiplomatic_capacity.png) **+20.00%** Diplomatic Capacity | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
| **Allow Chinese Embassies** Diplomatic actions will be carried out at the highest level, following Chinese rules. | * [![Monthly towards sinicized.png](/thumb.php?f=Monthly_towards_sinicized.png&width=32)](/File%3AMonthly_towards_sinicized.png) +0.10 Monthly Progress to Sinicized * [![Monthly towards centralization.png](/thumb.php?f=Monthly_towards_centralization.png&width=32)](/File%3AMonthly_towards_centralization.png) +0.05 Monthly Progress to Centralization * [![Monthly tribal cohesion.png](/thumb.php?f=Monthly_tribal_cohesion.png&width=32)](/File%3AMonthly_tribal_cohesion.png) **−0.10** Monthly Tribal Cohesion | 5 years | * custom\_tooltip:   + text: jurchen\_confederation\_law\_cooldown\_tt   + add\_cooldown:     - type: jurchen\_confederation\_law\_cooldown     - years: 5 * leader\_country:   + if:     - limit:       * ruler\_or\_regent:         + has\_variable: difficult\_sinicization\_variable     - add\_tribal\_cohesion: tribal\_cohesion\_mild\_penalty     - add\_stability: stability\_mild\_penalty | * [![Government power](/thumb.php?f=Monarchy.png&width=24)](/Economy#Government_power "Government power") **10** * [![Stability](/thumb.php?f=Stability.png&width=24)](/Economy#Stability "Stability") **10** |
...
[![icon](/thumb.php?f=Lordship_of_ireland_rule_law.png&width=64)](/File%3ALordship_of_ireland_rule_law.png "icon")
...
| Policy | Requirements | Country Modifier | On Activate |
| --- | --- | --- | --- |
| **Laudabiliter** Ireland was originally conquered by Anglo-Norman knights looking to seize some personal land and glory. However, the royal seat is impotent. |  | * [![Monthly religious influence.png](/thumb.php?f=Monthly_religious_influence.png&width=32)](/File%3AMonthly_religious_influence.png) **−0.10** Monthly Religious Influence * [![Global pop conversion speed.png](/thumb.php?f=Global_pop_conversion_speed.png&width=32)](/File%3AGlobal_pop_conversion_speed.png) **−50.00%** Pop Assimilation Speed * [![Casus belli.png](/thumb.php?f=Casus_belli.png&width=32)](/File%3ACasus_belli.png) Can Use Lordship of Ireland Casus Belli: **yes** | * custom\_tooltip: lordship\_of\_ireland\_rule\_laudabiliter\_policy\_tt |
| **Statutes of Kilkenny** Ordinances enforcing continental customs in Ireland, through banning Celtic dress and intermarriage, to keep the settler community distinct and dominant. | * current\_age\_or\_later:   + age: age\_2\_renaissance * Not:   + scope:recipient:     - leader\_country:       * culture:         + has\_culture\_group: Celtic | * [![Saffron negative.png](/thumb.php?f=Saffron_negative.png&width=32)](/File%3ASaffron_negative.png) Banned Saffron Shirts: **yes** * [![Global pop conversion speed.png](/thumb.php?f=Global_pop_conversion_speed.png&width=32)](/File%3AGlobal_pop_conversion_speed.png) **+50.00%** Pop Assimilation Speed * [![Blocked from marriage.png](/thumb.php?f=Blocked_from_marriage.png&width=32)](/File%3ABlocked_from_marriage.png) Celtic Marriage Banned: **yes** |  |
| **Religious Ascendancy** We may enforce members of the Lordship to convert to our religion. | * current\_age\_or\_later:   + age: age\_4\_reformation | * [![Tolerance heretic.png](/thumb.php?f=Tolerance_heretic.png&width=32)](/File%3ATolerance_heretic.png) **−2.00** Tolerance of Heretical Beliefs * [![Tolerance own.png](/thumb.php?f=Tolerance_own.png&width=32)](/File%3ATolerance_own.png) **+2.00** Tolerance of the True Faith * [![Saffron negative.png](/thumb.php?f=Saffron_negative.png&width=32)](/File%3ASaffron_negative.png) Banned Saffron Shirts: **yes** * [![Global pop conversion speed.png](/thumb.php?f=Global_pop_conversion_speed.png&width=32)](/File%3AGlobal_pop_conversion_speed.png) **+0.10** Pop Conversion Speed | * custom\_tooltip: lordship\_of\_ireland\_rule\_ascendancy\_policy\_tt |
...
[![icon](/thumb.php?f=Provincial_governorship.png&width=64)](/File%3AProvincial_governorship.png "icon")
...
[![icon](/thumb.php?f=Tianxia.png&width=64)](/File%3ATianxia.png "icon")
...
[![icon](/thumb.php?f=Jakun_gusa.png&width=64)](/File%3AJakun_gusa.png "icon")
...
[![icon](/thumb.php?f=Tax_base_system.png&width=64)](/File%3ATax_base_system.png "icon")
...
* leader\_country:
  + government\_power ≥ 25
* leader\_country:
  + Has the [![Single Whip Law](/thumb.php?f=Government_reform_single_whip_law.png&width=32)](/Government_reform#Single_Whip_Law "Single Whip Law") [Single Whip Law](/Government_reform#Single_Whip_Law "Government reform") Government Reform
  + gold:
    - GREATER\_THAN\_EQUAL:
      * value: this.monthly\_income\_trade\_and\_tax
      * multiply:
...
* leader\_country.capital.market:
  + Not:
    - is\_import\_banned: [![Silver](/thumb.php?f=Goods_silver.png&width=32)](/Goods#Silver "Silver") [Silver](/Goods#Silver "Goods")
...
[![icon](/thumb.php?f=Cefeng_tizhi.png&width=64)](/File%3ACefeng_tizhi.png "icon")
...
[![icon](/thumb.php?f=Keju_examination.png&width=64)](/File%3AKeju_examination.png "icon")
...
[![icon](/thumb.php?f=Outwards_view.png&width=64)](/File%3AOutwards_view.png "icon")
...
[![icon](/thumb.php?f=Mutual_defense_law.png&width=64)](/File%3AMutual_defense_law.png "icon")
...
[![icon](/thumb.php?f=Mutual_offense_law.png&width=64)](/File%3AMutual_offense_law.png "icon")
...
[![icon](/thumb.php?f=Main_philosophy_law.png&width=64)](/File%3AMain_philosophy_law.png "icon")
...
[![icon](/thumb.php?f=Vajrayana_law.png&width=64)](/File%3AVajrayana_law.png "icon")
...
[![icon](/thumb.php?f=Sect_school_law.png&width=64)](/File%3ASect_school_law.png "icon")
...
[![icon](/thumb.php?f=Guru_angad_guruship.png&width=64)](/File%3AGuru_angad_guruship.png "icon")
...
| Policy | Country Modifier |
| --- | --- |
| **Adi Granth** A collection of hymns from past Gurū compiled by guru\_arjan that will serve as the basis for our holy scriptures. | * [![Institution growth.png](/thumb.php?f=Institution_growth.png&width=32)](/File%3AInstitution_growth.png) **+10.00%** Institution Growth * [![Monthly towards innovative.png](/thumb.php?f=Monthly_towards_innovative.png&width=32)](/File%3AMonthly_towards_innovative.png) +0.025 Monthly Progress to Innovative |
| **Holy Abode** By enshrining the sacred scriptures inside the holy temples, we will turn them as the place of residence of Ik Onkar and a focus of pilgrimage for all Sikhism faithful. | * [![Cultural influence.png](/thumb.php?f=Cultural_influence.png&width=32)](/File%3ACultural_influence.png) **+10.00%** Cultural Influence % * [![Monthly towards centralization.png](/thumb.php?f=Monthly_towards_centralization.png&width=32)](/File%3AMonthly_towards_centralization.png) +0.025 Monthly Progress to Centralization |
| **Martyrdom** Our belief in Sikhism is strong, and we will not abandon it even under the threat of torture or even death. | * [![Land morale.png](/thumb.php?f=Land_morale.png&width=32)](/File%3ALand_morale.png) **+5.00%** Army Morale * [![Monthly towards defensive.png](/thumb.php?f=Monthly_towards_defensive.png&width=32)](/File%3AMonthly_towards_defensive.png) +0.025 Monthly Progress to Defensive |
...
| Policy | Country Modifier |
| --- | --- |
| **Akal Takht** The 'Throne of the Timeless One' will serve as the unquestionable seat of power for our Gurū and Sikhism. | * [![Monthly devotion.png](/thumb.php?f=Monthly_devotion.png&width=32)](/File%3AMonthly_devotion.png) **+0.10** Monthly Devotion * [![Monthly legitimacy.png](/thumb.php?f=Monthly_legitimacy.png&width=32)](/File%3AMonthly_legitimacy.png) **+0.10** Monthly Legitimacy * [![Monthly republican tradition.png](/thumb.php?f=Election_term_in_months.png&width=32)](/File%3AElection_term_in_months.png) **+0.10** Monthly Republican Tradition * [![Monthly towards aristocracy.png](/thumb.php?f=Monthly_towards_aristocracy.png&width=32)](/File%3AMonthly_towards_aristocracy.png) +0.025 Monthly Progress to Aristocracy |
| **Protection of the Poor** The power of military should not be used to oppress and become a tyrant, but to protect the vulnerable from such tyrants. | * [![Monthly war exhaustion.png](/thumb.php?f=Monthly_war_exhaustion.png&width=32)](/File%3AMonthly_war_exhaustion.png) **−0.025** Monthly War Exhaustion * [![Monthly towards free subjects.png](/thumb.php?f=Monthly_towards_free_subjects.png&width=32)](/File%3AMonthly_towards_free_subjects.png) +0.025 Monthly Progress to Free Subjects |
| **Mīrī Pīrī** Only by combining temporal power and spiritual authority under the figure of the Gurū can Sikhism truly achieve its deserved glory. | * [![Discipline.png](/thumb.php?f=Discipline.png&width=32)](/File%3ADiscipline.png) **+2.50%** Discipline * [![Monthly towards belligerent.png](/thumb.php?f=Monthly_towards_belligerent.png&width=32)](/File%3AMonthly_towards_belligerent.png) +0.025 Monthly Progress to Belligerent |

#### Khalsa

[![icon](/thumb.php?f=Khalsa_law.png&width=64)](/File%3AKhalsa_law.png "icon")
...
| --- | --- | --- |
| **Guru Panth** The leadership of Sikhism would lay on the Khalsa as a whole, which would serve as its Gurū. |  | * [![Monthly army tradition.png](/thumb.php?f=Monthly_army_tradition.png&width=32)](/File%3AMonthly_army_tradition.png) **+0.05** Monthly Army Tradition * [![Monthly towards belligerent.png](/thumb.php?f=Monthly_towards_belligerent.png&width=32)](/File%3AMonthly_towards_belligerent.png) +0.025 Monthly Progress to Belligerent |
| **Khalsa Fauj** Only by organizing the military forces of the Khalsa into a mighty army will they will be able to serve their function as protectors of Sikhism. | * international\_organization\_has\_unlocked\_policy\_trigger:   + type: khalsa\_fauj | * [![Army infantry maintenance cost modifier.png](/thumb.php?f=Army_infantry_maintenance_cost_modifier.png&width=32)](/File%3AArmy_infantry_maintenance_cost_modifier.png) **−5.00%** Heavy Infantry Maintenance Cost * [![Monthly towards quantity.png](/thumb.php?f=Monthly_towards_quantity.png&width=32)](/File%3AMonthly_towards_quantity.png) +0.025 Monthly Progress to Quantity |
| **Amrit Sanskar** The members of the Khalsa are not just brutes thrown to fight, but refined individuals who uphold the rites of initiation and the rules of conduct and dress code placed upon them as members of the community. The prestige of the Khalsa is not on the might of its warriors but on the appeal of their purity. | * international\_organization\_has\_unlocked\_policy\_trigger:   + type: amrit\_sanskar | * [![Global pop conversion speed.png](/thumb.php?f=Global_pop_conversion_speed.png&width=32)](/File%3AGlobal_pop_conversion_speed.png) **+5.00%** Pop Conversion Speed % * [![Monthly towards humanist.png](/thumb.php?f=Monthly_towards_humanist.png&width=32)](/File%3AMonthly_towards_humanist.png) +0.025 Monthly Progress to Humanist |

### Religious Laws

#### guru\_nanak Teachings

[![icon](/thumb.php?f=Guru_nanak_guruship.png&width=64)](/File%3AGuru_nanak_guruship.png "icon")
...
| Policy | Country Modifier |
| --- | --- |
| **Vaṇḍ Chakō** Meaning 'share and consume', it is one of the pillars of guru\_nanak. It encourages the sharing of all that is available and the collective consume of it by the community. | * [![Global estate target satisfaction.png](/thumb.php?f=Global_estate_target_satisfaction.png&width=32)](/File%3AGlobal_estate_target_satisfaction.png) **+10.00%** Estates Satisfaction Equilibrium * [![Monthly towards communalism.png](/thumb.php?f=Monthly_towards_communalism.png&width=32)](/File%3AMonthly_towards_communalism.png) +0.025 Monthly Progress to Communalism |
| **Kirat Karō** Meaning 'work honestly', it is one of the pillars of guru\_nanak. It means dedication and honestly to hard labor, as exercise of what Ik Onkar has given us. | * [![Global production efficiency.png](/thumb.php?f=Global_production_efficiency.png&width=32)](/File%3AGlobal_production_efficiency.png) **+5.00%** Production Efficiency |
| **Nām Japō** Meaning 'recite His name', it is one of the pillars of guru\_nanak. It means to meditate and contemplate the many names of Ik Onkar, to achieve connection with Him. | * [![Stability investment.png](/thumb.php?f=Stability_investment.png&width=32)](/File%3AStability_investment.png) **+0.01** Stability Investment * [![Monthly towards spiritualist.png](/thumb.php?f=Monthly_towards_spiritualist.png&width=32)](/File%3AMonthly_towards_spiritualist.png) +0.025 Monthly Progress to Spiritualist |
...
| Policy | Country Modifier |
| --- | --- |
| **Gurmukhī Script** A script developed and standardized by guru\_angad, it will become the primary scripture for Sikhism. | * [![Global monthly literacy.png](/thumb.php?f=Global_monthly_literacy.png&width=32)](/File%3AGlobal_monthly_literacy.png) **+0.01%** Monthly Literacy * [![Monthly towards innovative.png](/thumb.php?f=Monthly_towards_innovative.png&width=32)](/File%3AMonthly_towards_innovative.png) +0.025 Monthly Progress to Innovative |
| **Langar Community** A communal kitchen attached to any temple, they will serve food freely to all people, regardless of their creed, status, or ethnicity. | * [![Global monthly food modifier.png](/thumb.php?f=Global_monthly_food_modifier.png&width=32)](/File%3AGlobal_monthly_food_modifier.png) **+10.00%** Food Production % * [![Monthly towards communalism.png](/thumb.php?f=Monthly_towards_communalism.png&width=32)](/File%3AMonthly_towards_communalism.png) +0.025 Monthly Progress to Communalism |
| **Mall Akhāṛā** Wrestling arenas for the people to practice will serve not only as a way to keep their bodies healthy, but also as an improvement of their martial prowess. | * [![Army infantry power.png](/thumb.php?f=Army_infantry_power.png&width=32)](/File%3AArmy_infantry_power.png) **+5.00%** Heavy Infantry Power * [![Monthly towards land.png](/thumb.php?f=Monthly_towards_land.png&width=32)](/File%3AMonthly_towards_land.png) +0.025 Monthly Progress to Land |
...
| Policy | Country Modifier |
| --- | --- |
| **Urbanization Projects** Through serious dedication and communal voluntary work, the holiest and most splendorous of Sikhism cities can be built. | * [![Global monthly development.png](/thumb.php?f=Global_monthly_development.png&width=32)](/File%3AGlobal_monthly_development.png) **+0.0010** Monthly Development * [![Monthly towards inward.png](/thumb.php?f=Monthly_towards_inward.png&width=32)](/File%3AMonthly_towards_inward.png) +0.025 Monthly Progress to Inward |
| **Scripture Hymns** The scripture is the holiest of books, and it has to be embellished by the appropriate hymns lauding its glory. | * [![Monthly prestige.png](/thumb.php?f=Monthly_prestige.png&width=32)](/File%3AMonthly_prestige.png) **+0.10** Monthly Prestige * [![Monthly towards spiritualist.png](/thumb.php?f=Monthly_towards_spiritualist.png&width=32)](/File%3AMonthly_towards_spiritualist.png) +0.025 Monthly Progress to Spiritualist |
| **Masand System** A system of missionaries and preachers, they will spread the Sikhism further away from the Gurū while serving as tax collectors at the same time. | * [![Global pop conversion speed.png](/thumb.php?f=Global_pop_conversion_speed.png&width=32)](/File%3AGlobal_pop_conversion_speed.png) **+5.00%** Pop Conversion Speed % * [![Monthly towards outward.png](/thumb.php?f=Monthly_towards_outward.png&width=32)](/File%3AMonthly_towards_outward.png) +0.025 Monthly Progress to Outward |
...
| Policy | Country Modifier |
| --- | --- |
| **Sikhism Pluralism** While the Khalsa is intended to be the protector of Sikhism, not all the faithful are part of it. As such, it inherently proves there is pluralism inside the faith, and that is something that enriches us. | * [![Court spending cost.png](/thumb.php?f=Get_claim_from_imperial_court_cost_modifier.png&width=32)](/File%3AGet_claim_from_imperial_court_cost_modifier.png) **+10.00%** Court Spending Efficiency * [![Monthly towards plutocracy.png](/thumb.php?f=Monthly_towards_plutocracy.png&width=32)](/File%3AMonthly_towards_plutocracy.png) +0.025 Monthly Progress to Plutocracy |
| **Dharamyudh** A 'war of righteousness' is any war that serves the purpose of defending Sikhism and its followers. War should be a last resort, but all must be ready to wage it to defend the faith and stop tyranny. | * [![Monthly war exhaustion.png](/thumb.php?f=Monthly_war_exhaustion.png&width=32)](/File%3AMonthly_war_exhaustion.png) **−0.025** Monthly War Exhaustion * [![Monthly towards spiritualist.png](/thumb.php?f=Monthly_towards_spiritualist.png&width=32)](/File%3AMonthly_towards_spiritualist.png) +0.025 Monthly Progress to Spiritualist |
| **Dasam Granth** A collection of various texts of poetry composed by guru\_gobind\_singh, it is considered equal in status to the Adi Granth and it is enshrined next to it in the temples. | * [![Research speed.png](/thumb.php?f=Research_speed.png&width=32)](/File%3AResearch_speed.png) **+5.00%** Monthly Research Progress % * [![Monthly towards innovative.png](/thumb.php?f=Monthly_towards_innovative.png&width=32)](/File%3AMonthly_towards_innovative.png) +0.025 Monthly Progress to Innovative |
...
| Policy | Country Modifier |
| --- | --- |
| **Dasvandh Tax** Meaning the 'tenth part', it is a system of revenue collection which establishes that a tenth of one's income should be donated in the name of the Gurū. | * [![Global estate max tax.png](/thumb.php?f=Global_estate_max_tax.png&width=32)](/File%3AGlobal_estate_max_tax.png) **+5.00%** Maximum Tax * [![Monthly towards capital economy.png](/thumb.php?f=Monthly_towards_capital_economy.png&width=32)](/File%3AMonthly_towards_capital_economy.png) +0.025 Monthly Progress to Capital Economy |
| **Ānada Kāraja** Meaning 'act towards happiness', it is the wedding ceremony for Sikhism as defined by guru\_amar\_das. The hymns sung in it celebrate the union with the divine. | * [![Cultural tradition.png](/thumb.php?f=Cultural_tradition.png&width=32)](/File%3ACultural_tradition.png) **+10.00%** Cultural Tradition % * [![Monthly towards traditionalist.png](/thumb.php?f=Monthly_towards_traditionalist.png&width=32)](/File%3AMonthly_towards_traditionalist.png) +0.025 Monthly Progress to Traditionalist |
| **Sangat Equality** Men an women are equal under Ik Onkar, and thus both are equally valid to be part of the Sangat monastic community, and even to lead it. | * [![Gender equality.png](/thumb.php?f=Gender_equality.png&width=32)](/File%3AGender_equality.png) Gender Equality: **yes** * [![Monthly towards humanist.png](/thumb.php?f=Monthly_towards_humanist.png&width=32)](/File%3AMonthly_towards_humanist.png) +0.025 Monthly Progress to Humanist |
...
| Policy | Country Modifier |
| --- | --- |
| **Impartial Manji Heads** The ones at the head of our many religious administrations should not show partiality towards any opinion, but serve dutifully the interests of Sikhism. | * [![Monthly inflation.png](/thumb.php?f=Monthly_inflation.png&width=32)](/File%3AMonthly_inflation.png) **−0.10%** Monthly Inflation * [![Monthly towards decentralization.png](/thumb.php?f=Monthly_towards_decentralization.png&width=32)](/File%3AMonthly_towards_decentralization.png) +0.025 Monthly Progress to Decentralization |
| **Fragrance of a Flower** If one plucks a flower with one hand and gives it away with the other, both hands get the same fragrance. As such, no matter our different religious beliefs, we are all touched by the same divine spirit. | * [![Improve relation impact.png](/thumb.php?f=Improve_relation_impact.png&width=32)](/File%3AImprove_relation_impact.png) **+10.00%** Improve Relations * [![Monthly towards conciliatory.png](/thumb.php?f=Monthly_towards_conciliatory.png&width=32)](/File%3AMonthly_towards_conciliatory.png) +0.025 Monthly Progress to Conciliatory |
| **Nature Guardian** Our natural environment is not there to serve us, but for us to live in harmony with it. As such, we must protect it and provide for it as much as it provides for us. | * [![Global devastation recovery.png](/thumb.php?f=Global_devastation_recovery.png&width=32)](/File%3AGlobal_devastation_recovery.png) **+0.50%** Prosperity Recovery * [![Monthly towards communalism.png](/thumb.php?f=Monthly_towards_communalism.png&width=32)](/File%3AMonthly_towards_communalism.png) +0.025 Monthly Progress to Communalism |
...
| Policy | Country Modifier |
| --- | --- |
| **Treat the Sick** Diseases and pestilence are the bane of humanity. We shall treat all sick people diligently, so that we can ensure a healthy society. | * [![Local disease resistance.png](/thumb.php?f=Local_disease_resistance.png&width=32)](/File%3ALocal_disease_resistance.png) **+5%** Disease Resistance * [![Monthly towards humanist.png](/thumb.php?f=Monthly_towards_humanist.png&width=32)](/File%3AMonthly_towards_humanist.png) +0.025 Monthly Progress to Humanist |
| **Unexpected Knowledge** The spiritual powers of the Gurū are undeniable, as they have been said to have known truths and facts that they had no way of knowing through normal methods. At the same time, people apparently illiterate may be able to discuss theology with the most learned scholar. | * [![Embrace institution cost modifier.png](/thumb.php?f=Embrace_institution_cost_modifier.png&width=32)](/File%3AEmbrace_institution_cost_modifier.png) **−10.00%** Embrace Institution Cost * [![Monthly towards individualism.png](/thumb.php?f=Monthly_towards_individualism.png&width=32)](/File%3AMonthly_towards_individualism.png) +0.025 Monthly Progress to Individualism |
| **Young Humility** No matter how much one has learned, there are always sources of knowledge outside of one's grasp, and people who have mastered them. Even the younger ones may harbor knowledge out of the understanding of the more senior minds. In this sense, all minds are like that of an infant. | * [![Global max literacy.png](/thumb.php?f=Global_max_literacy.png&width=32)](/File%3AGlobal_max_literacy.png) **+5.00%** Max Literacy * [![Monthly towards quality.png](/thumb.php?f=Monthly_towards_quality.png&width=32)](/File%3AMonthly_towards_quality.png) +0.025 Monthly Progress to Quality |
...
| Policy | Country Modifier |
| --- | --- |
| **Word of a Sikhism** The solemn vow of a follower of Sikhism is to be understood as been made in the presence of Ik Onkar, and as such it should be unbreakable. | * [![Diplomatic reputation.png](/thumb.php?f=Diplomatic_reputation.png&width=32)](/File%3ADiplomatic_reputation.png) **+1.00** Diplomatic Reputation * [![Monthly towards conciliatory.png](/thumb.php?f=Monthly_towards_conciliatory.png&width=32)](/File%3AMonthly_towards_conciliatory.png) +0.025 Monthly Progress to Conciliatory |
| **Gurū Travels** If a Gurū stays only in one place, the message of Sikhism will not be able to spread. A Gurū must thus travel and have contact with foreign peoples and beliefs. | * [![Tolerance heretic.png](/thumb.php?f=Tolerance_heretic.png&width=32)](/File%3ATolerance_heretic.png) **+1.00** Tolerance of Heretical Beliefs * [![Monthly towards outward.png](/thumb.php?f=Monthly_towards_outward.png&width=32)](/File%3AMonthly_towards_outward.png) +0.025 Monthly Progress to Outward |
| **Resist Persecution** Enemies of the true faith will always persecute the faithful, but our beliefs are strong and they will not be able to break us. | * [![Global hostile attrition.png](/thumb.php?f=Global_hostile_attrition.png&width=32)](/File%3AGlobal_hostile_attrition.png) **+0.50%** Hostile Attrition * [![Monthly towards defensive.png](/thumb.php?f=Monthly_towards_defensive.png&width=32)](/File%3AMonthly_towards_defensive.png) +0.025 Monthly Progress to Defensive |

#### Guru Granth Sahib Teachings

[![icon](/thumb.php?f=Guru_granth_sahib_guruship.png&width=64)](/File%3AGuru_granth_sahib_guruship.png "icon")
...
| Policy | Country Modifier |
| --- | --- |
| **Eternally Living Gurū** The Guru Granth Sahib is the final and sovereign eternal Gurū, which shall be the guiding light for all followers of Sikhism. | * [![Cultural influence.png](/thumb.php?f=Cultural_influence.png&width=32)](/File%3ACultural_influence.png) **+10.00%** Cultural Influence % * [![Monthly towards outward.png](/thumb.php?f=Monthly_towards_outward.png&width=32)](/File%3AMonthly_towards_outward.png) +0.025 Monthly Progress to Outward |
| **Divine Justice** The teachings encoded in the Guru Granth Sahib guide our society to live in peace and harmony, based on Ik Onkar and His justice. | * [![Global population growth.png](/thumb.php?f=Global_population_growth.png&width=32)](/File%3AGlobal_population_growth.png) **+0.025%** Population Growth * [![Monthly towards free subjects.png](/thumb.php?f=Monthly_towards_free_subjects.png&width=32)](/File%3AMonthly_towards_free_subjects.png) +0.025 Monthly Progress to Free Subjects |
| **Unchanging Writing** The Guru Granth Sahib was composed during the course of many years and by more than one Gurū, but it has now reached its definite and eternal form. Its writings shall no longer be altered in any way. | * [![Cultural tradition.png](/thumb.php?f=Cultural_tradition.png&width=32)](/File%3ACultural_tradition.png) **+10.00%** Cultural Tradition % * [![Monthly towards traditionalist.png](/thumb.php?f=Monthly_towards_traditionalist.png&width=32)](/File%3AMonthly_towards_traditionalist.png) +0.025 Monthly Progress to Traditionalist |
...
[![icon](/thumb.php?f=Sc_internal_politics.png&width=64)](/File%3ASc_internal_politics.png "icon")
...
[![icon](/thumb.php?f=Sc_membership_regulation.png&width=64)](/File%3ASc_membership_regulation.png "icon")
...
[![icon](/thumb.php?f=Sc_unification.png&width=64)](/File%3ASc_unification.png "icon")
      ...
      * All of:
        ...
        + At least one of:
          - any\_international\_organization\_member:
            ...
            * count: all
          - any\_international\_organization\_member:
            * religion: [![Lutheranism](/thumb.php?f=Religion_lutheran.png&width=32)](/Religion#Lutheranism "Lutheranism") [Lutheranism](/Religion#Lutheranism "Religion")
            * count: all
          - any\_international\_organization\_member:
            * religion: [![Calvinism](/thumb.php?f=Religion_calvinist.png&width=32)](/Religion#Calvinism "Calvinism") [Calvinism](/Religion#Calvinism "Religion")
            * count: all
  + At least one of:
    - international\_organization\_has\_policy: [Mending the Schism](/Law#Religious_Affairs "Law")
    - All of:
...
[![icon](/thumb.php?f=Sc_policy_proposal_frequency.png&width=64)](/File%3ASc_policy_proposal_frequency.png "icon")
...
| --- | --- |
| **Frequent Policy Proposals** Adjustment of laws and policies is a frequent act, and as such happens in Swiss Confederation on a base of every 4 years. | * [![Policy vote delay.png](/thumb.php?f=Policy_vote_delay.png&width=32)](/File%3APolicy_vote_delay.png) +4 Policy Vote Delay |
| **Moderate Policy Proposals** While a significant process, administrating the laws and policy proposals within the Swiss Confederation takes considerable effort, which allows law proposals only every 8 years. | * [![Policy vote delay.png](/thumb.php?f=Policy_vote_delay.png&width=32)](/File%3APolicy_vote_delay.png) +8 Policy Vote Delay |

#### Swiss Representative

[![icon](/thumb.php?f=Sc_representative.png&width=64)](/File%3ASc_representative.png "icon")
...
* international\_organization\_type: international\_organization\_type:swiss\_confederation
* international\_organization\_has\_law: [![Swiss Representative](/thumb.php?f=Sc_representative.png&width=32)](/Law#Swiss_Representative "Swiss Representative") [Swiss Representative](/Law#Swiss_Representative "Law")
...
[![icon](/thumb.php?f=Sc_ruling_period.png&width=64)](/File%3ASc_ruling_period.png "icon")
...
[![icon](/thumb.php?f=Sc_election_frequency.png&width=64)](/File%3ASc_election_frequency.png "icon")
...
[![icon](/thumb.php?f=Sc_relations_with_hre.png&width=64)](/File%3ASc_relations_with_hre.png "icon")
...
[![icon](/thumb.php?f=Sc_power_of_the_sovereign.png&width=64)](/File%3ASc_power_of_the_sovereign.png "icon")
...
| **Religious Power** The power of the [GetUniqueInternationalOrganization('swiss\_confederation').GetLeaderTitle] is limited with the exception in the matters of religious affairs of the Swiss Confederation. | * trigger\_if:   + limit:     - law\_visible\_to\_international\_organization: [![Religious Affairs](/thumb.php?f=Sc_religious_affairs.png&width=32)](/Law#Religious_Affairs "Religious Affairs") [Religious Affairs](/Law#Religious_Affairs "Law")   + international\_organization\_has\_policy: [Mending the Schism](/Law#Religious_Affairs "Law") * international\_organization\_has\_policy: [Lifelong](/Law#Ruling_Period "Law") |
| **Absolute Power** The leading [GetUniqueInternationalOrganization('swiss\_confederation').GetLeaderTitle] rules over the Swiss Confederation as if it was a singular state. As such, they enjoy all the privileges and duties as if they were a monarch of the Confederation. | * trigger\_if:   + limit:     - law\_visible\_to\_international\_organization: [![Imperial Relations](/thumb.php?f=Sc_relations_with_hre.png&width=32)](/Law#Imperial_Relations "Imperial Relations") [Imperial Relations](/Law#Imperial_Relations "Law")   + international\_organization\_has\_law: [![Imperial Relations](/thumb.php?f=Sc_relations_with_hre.png&width=32)](/Law#Imperial_Relations "Imperial Relations") [Imperial Relations](/Law#Imperial_Relations "Law") * international\_organization\_has\_policy: [Lifelong](/Law#Ruling_Period "Law") |

### Military Laws

#### War Politics

[![icon](/thumb.php?f=Sc_war_politics.png&width=64)](/File%3ASc_war_politics.png "icon")
...
[![icon](/thumb.php?f=Sc_religious_affairs.png&width=64)](/File%3ASc_religious_affairs.png "icon")
...
[![icon](/thumb.php?f=Union_codified_inheritance_law.png&width=64)](/File%3AUnion_codified_inheritance_law.png "icon")
...
* international\_organization\_has\_law: [![Union Foundation](/thumb.php?f=Union_foundation_law.png&width=32)](/Law#Union_Foundation "Union Foundation") [Union Foundation](/Law#Union_Foundation "Law")
...
* international\_organization\_has\_law: [![Codified Inheritance](/thumb.php?f=Union_codified_inheritance_law.png&width=32)](/Law#Codified_Inheritance "Codified Inheritance") [Codified Inheritance](/Law#Codified_Inheritance "Law")

Locked

* international\_organization\_has\_law: [![Economy of the Union](/thumb.php?f=Union_economic_law.png&width=32)](/Law#Economy_of_the_Union "Economy of the Union") [Economy of the Union](/Law#Economy_of_the_Union "Law")
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **Unified Treasury** The different treasuries of the Union shall be unified into one single entity which fills the coffers of the monarch and allows them to spend the gold in the best interest of the Union. | * custom\_description:   + text: is\_same\_ruler\_personal\_union\_text   + any\_international\_organization\_member:     - ruler:       * save\_temporary\_scope\_as: ruler\_character   + any\_international\_organization\_member:     - ruler: scope:ruler\_character     - count > 1 * international\_organization\_has\_policy: [Establish Seniority](/Law#Union_Foundation "Law") * trigger\_if:   + limit:     - has\_special\_status\_available: special\_status:senior\_partner   + any\_country\_with\_special\_status\_of\_type:     - type: senior\_partner     - government\_type: government\_type:monarchy * trigger\_else:   + has\_special\_status\_available: special\_status:senior\_partner * international\_organization\_has\_policy: [Unified Succession Law](/Law#Codified_Inheritance "Law") | * [![Country cabinet efficiency.png](/thumb.php?f=Country_cabinet_efficiency.png&width=32)](/File%3ACountry_cabinet_efficiency.png) **+5.00%** Efficiency of Our Cabinet | * on\_union\_policy\_change\_effect: True * change\_union\_integration\_level:   + value: 1 | * change\_union\_integration\_level:   + value: -1 |  |  |  | * [![Union integration level.png](/thumb.php?f=Union_integration_level.png&width=32)](/File%3AUnion_integration_level.png) **+1** Union Integration Level | * union\_contribution |
| **Cooperative Investment** The treasuries of the members of the Union serve nobody exclusively. They are part of the royal commune, and shall be used to improve the infrastructure of every member. |  |  | * on\_union\_policy\_change\_effect: True |  | [![Can Build Buildings In Members](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Can Build Buildings In Members") | [![Can Build Rgos In Members](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Can Build Rgos In Members") | [![Can Build Roads In Members](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Can Build Roads In Members") |  |  |

#### Diplomatic Liberties

[![icon](/thumb.php?f=Union_diplomatic_law.png&width=64)](/File%3AUnion_diplomatic_law.png "icon")
...
* international\_organization\_has\_law: [![Diplomatic Liberties](/thumb.php?f=Union_diplomatic_law.png&width=32)](/Law#Diplomatic_Liberties "Diplomatic Liberties") [Diplomatic Liberties](/Law#Diplomatic_Liberties "Law")
* international\_organization\_has\_policy: [Aligned Legislature](/Law#Legislature_of_the_Union "Law")

| Policy | Requirements | Country Modifier | On Activate | On Deactivate | International Organization Modifier |
| --- | --- | --- | --- | --- | --- |
| **Unified External Diplomacy** The diplomatic affairs of the Union are centralized in the Senior Partner, while the other members are limited in their foreign diplomacy. The matters of warfare, however, are still in the hands of the Estates, even though now they are significantly more incentivized to take less risks in their endeavors. | * custom\_description:   + text: is\_same\_ruler\_personal\_union\_text   + any\_international\_organization\_member:     - ruler:       * save\_temporary\_scope\_as: ruler\_character   + any\_international\_organization\_member:     - ruler: scope:ruler\_character     - count > 1 * international\_organization\_has\_policy: [Establish Seniority](/Law#Union_Foundation "Law") * trigger\_if:   + limit:     - has\_special\_status\_available: special\_status:senior\_partner   + any\_country\_with\_special\_status\_of\_type:     - type: senior\_partner     - government\_type: government\_type:monarchy * trigger\_else:   + has\_special\_status\_available: special\_status:senior\_partner * international\_organization\_has\_policy: [Unified Treasury](/Law#Economy_of_the_Union "Law") |  | * on\_union\_policy\_change\_effect: True * change\_union\_integration\_level:   + value: 1 | * change\_union\_integration\_level:   + value: -1 | * [![Union integration level.png](/thumb.php?f=Union_integration_level.png&width=32)](/File%3AUnion_integration_level.png) **+1** Union Integration Level * [![Allowed enforce peace.png](/thumb.php?f=Allowed_enforce_peace.png&width=32)](/File%3AAllowed_enforce_peace.png) Allow Enforce Union Peace in Union: **yes** * [![Allow diplomacy force embargo.png](/thumb.php?f=Allow_diplomacy_force_embargo.png&width=32)](/File%3AAllow_diplomacy_force_embargo.png) Unlock Rein in Junior Diplomacy: **yes** |
| **Organized Diplomats** The diplomats of the Union serve no singular banner, but the entirety of the Union. Each member has access to their abilities and can utilize them for their own foreign affairs. |  | * [![Diplomatic capacity.png](/thumb.php?f=Diplomatic_capacity.png&width=32)](/File%3ADiplomatic_capacity.png) **+10.00%** Diplomatic Capacity * [![Monthly diplomats.png](/thumb.php?f=Monthly_diplomats.png&width=32)](/File%3AMonthly_diplomats.png) **+0.10** Monthly Diplomats * [![Diplomatic capacity.png](/thumb.php?f=Diplomatic_capacity.png&width=32)](/File%3ADiplomatic_capacity.png) **+1.00** Maximum Diplomats | * on\_union\_policy\_change\_effect: True |  |  |

#### Legislature of the Union

[![icon](/thumb.php?f=Union_legislature_law.png&width=64)](/File%3AUnion_legislature_law.png "icon")
...
* international\_organization\_has\_law: [![Legislature of the Union](/thumb.php?f=Union_legislature_law.png&width=32)](/Law#Legislature_of_the_Union "Legislature of the Union") [Legislature of the Union](/Law#Legislature_of_the_Union "Law")
* international\_organization\_has\_law: [![Question of Unification](/thumb.php?f=Union_unification_of_crowns_law.png&width=32)](/Law#Question_of_Unification "Question of Unification") [Question of Unification](/Law#Question_of_Unification "Law")
* Not:
  + international\_organization\_has\_policy: [Federal Union](/Law#Question_of_Unification "Law")

| Policy | Requirements | Country Modifier | On Activate | On Deactivate | International Organization Modifier |
| --- | --- | --- | --- | --- | --- |
| **Aligned Legislature** In order to keep administrative cohesion and consistency within the Union, all laws and policies shall be aligned with the ones of the Senior Partner. | * custom\_description:   + text: is\_same\_ruler\_personal\_union\_text   + any\_international\_organization\_member:     - ruler:       * save\_temporary\_scope\_as: ruler\_character   + any\_international\_organization\_member:     - ruler: scope:ruler\_character     - count > 1 * international\_organization\_has\_policy: [Establish Seniority](/Law#Union_Foundation "Law") * trigger\_if:   + limit:     - has\_special\_status\_available: special\_status:senior\_partner   + any\_country\_with\_special\_status\_of\_type:     - type: senior\_partner     - government\_type: government\_type:monarchy * trigger\_else:   + has\_special\_status\_available: special\_status:senior\_partner * international\_organization\_has\_policy: [Unified External Diplomacy](/Law#Diplomatic_Liberties "Law") | * [![Legislative efficiency.png](/thumb.php?f=Legislative_efficiency.png&width=32)](/File%3ALegislative_efficiency.png) **+10.00%** Legislative Efficiency | * on\_union\_policy\_change\_effect: True * apply\_same\_laws\_policy\_effect: True * change\_union\_integration\_level:   + value: 1 | * change\_union\_integration\_level:   + value: -1 | * [![Union integration level.png](/thumb.php?f=Union_integration_level.png&width=32)](/File%3AUnion_integration_level.png) **+1** Union Integration Level * [![Change heir selection cost modifier.png](/thumb.php?f=Change_heir_selection_cost_modifier.png&width=32)](/File%3AChange_heir_selection_cost_modifier.png) Enabled Union Enforcement Actions: **yes** |
| **Federal Legislature** Differences in customs and laws are no flaw but a primary aspect of the different members of the Union. As such, the design of policies is an untouchable responsibility of the member states instead of the ruler. |  | * [![Country cabinet efficiency.png](/thumb.php?f=Country_cabinet_efficiency.png&width=32)](/File%3ACountry_cabinet_efficiency.png) **+10.00%** Efficiency of Our Cabinet | * on\_union\_policy\_change\_effect: True |  |  |

#### Question of Unification

[![icon](/thumb.php?f=Union_unification_of_crowns_law.png&width=64)](/File%3AUnion_unification_of_crowns_law.png "icon")
...
[![icon](/thumb.php?f=Union_mutual_offense_law.png&width=64)](/File%3AUnion_mutual_offense_law.png "icon")
...
[![icon](/thumb.php?f=Union_foundation_law.png&width=64)](/File%3AUnion_foundation_law.png "icon")
...
| --- | --- | --- | --- | --- |
| **Establish Seniority** The Union can only hold together from a single throne. Designating the senior partner of the Union shall also determine which throne shall represent the Union as a whole. | * custom\_description:   + text: is\_same\_ruler\_personal\_union\_text   + any\_international\_organization\_member:     - ruler:       * save\_temporary\_scope\_as: ruler\_character   + any\_international\_organization\_member:     - ruler: scope:ruler\_character     - count > 1 |  | * custom\_tooltip: union\_senior\_partner\_policy\_at * on\_union\_policy\_change\_effect: True * if:   + limit:     - Not:       * has\_variable: pre\_selected\_senior\_partner   + custom\_tooltip: union\_senior\_partner\_policy\_tt * else:   + custom\_tooltip: union\_senior\_partner\_policy\_specific\_tt * set\_parliament\_type: parliament\_type:union\_royal\_assembly * custom\_tooltip: union\_unlocks\_independence\_casus\_belli\_tt * custom\_tooltip: union\_unlocks\_war\_for\_seniority\_casus\_belli\_tt | [![Has Parliament](/thumb.php?f=Yes.png&width=20)](/File%3AYes.png "Has Parliament") |
| **Maintain Federal Status** The sovereignty of each member of the Union is untouchable and unquestionable. Even if each throne is ruled by a single ruler, it is not the monarch's business to meddle in the affairs of the union members. |  | * [![Stability investment.png](/thumb.php?f=Stability_investment.png&width=32)](/File%3AStability_investment.png) **+0.01** Stability Investment | * on\_union\_policy\_change\_effect: True |  |
