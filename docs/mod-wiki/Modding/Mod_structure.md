...
| --- | --- | --- |
| `INJECT:key` | ![Yes](/thumb.php?f=Yes.png&width=24 "Yes") | Adds the insides into the original object |
| `REPLACE:key` | ![Yes](/thumb.php?f=Yes.png&width=24 "Yes") | Replaces the original with this definition |
| `TRY_INJECT:key` | ![No](/thumb.php?f=No.png&width=24 "No") | Adds the insides into the original object. If the object does not exist, ignores this. |
| `TRY_REPLACE:key` | ![No](/thumb.php?f=No.png&width=24 "No") | Replaces the original with this definition. If the object does not exist, ignores this. |
| `INJECT_OR_CREATE:key` | ![No](/thumb.php?f=No.png&width=24 "No") | Adds the insides into the original object. If no such object, exists, creates it |
| `REPLACE_OR_CREATE:key` | ![No](/thumb.php?f=No.png&width=24 "No") | Replaces the original with this definition. If no such object, exists, creates it |
